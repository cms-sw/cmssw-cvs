...
process.configurationMetadata = cms.untracked.PSet(
    ...
    name = cms.untracked.string('$Source: /cvs_server/repositories/CMSSW/CMSSW/FastSimulation/Configuration/python/PYTHIA6_MinBias_2360GeV_cff_py_GEN_FASTSIM.py,v $')
)
