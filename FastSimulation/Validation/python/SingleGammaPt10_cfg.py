...
process.configurationMetadata = cms.untracked.PSet(
    ...
    name = cms.untracked.string('$Source: /afs/cern.ch/work/c/cmsbuild/public/cvs/CMSSW/CMSSW/FastSimulation/Validation/python/Attic/SingleGammaPt10_cfg.py,v $'),
    annotation = cms.untracked.string('RelVal FastSim single particle gun photons, Pt=10 GeV')
)
process.ReleaseValidation = cms.untracked.PSet(
    ...
    primaryDatasetName = cms.untracked.string('RelValFastSimSingleGammaPt10')
)
