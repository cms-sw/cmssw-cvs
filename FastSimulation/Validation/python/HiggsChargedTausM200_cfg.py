...
process.configurationMetadata = cms.untracked.PSet(
    ...
    name = cms.untracked.string('$Source: /afs/cern.ch/work/c/cmsbuild/public/cvs/CMSSW/CMSSW/FastSimulation/Validation/python/Attic/HiggsChargedTausM200_cfg.py,v $'),
