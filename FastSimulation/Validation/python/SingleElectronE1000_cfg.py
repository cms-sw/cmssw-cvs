...
process.configurationMetadata = cms.untracked.PSet(
    ...
    name = cms.untracked.string('$Source: /afs/cern.ch/work/c/cmsbuild/public/cvs/CMSSW/CMSSW/FastSimulation/Validation/python/Attic/SingleElectronE1000_cfg.py,v $'),
    annotation = cms.untracked.string('RelVal FastSim single particle gun electrons, E=1000 GeV')
)
process.ReleaseValidation = cms.untracked.PSet(
    ...
    primaryDatasetName = cms.untracked.string('RelValFastSimSingleElectronE1000')
)
...
process.source = cms.Source("FlatRandomEGunSource",
    ...
    psethack = cms.string('single ele E=1000'),
