...
process.configurationMetadata = cms.untracked.PSet(
    ...
    name = cms.untracked.string('$Source: /afs/cern.ch/work/c/cmsbuild/public/cvs/CMSSW/CMSSW/FastSimulation/Validation/python/Attic/RS1GravitonGammaM1500_cfg.py,v $'),
