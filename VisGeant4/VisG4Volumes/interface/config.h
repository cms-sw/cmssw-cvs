#ifndef VIS_G4_VOLUMES_CONFIG_H
# define VIS_G4_VOLUMES_CONFIG_H
...
/** @def VIS_G4_VOLUMES_API
  @brief A macro that controls how entities of this shared library are
         ...
         exported if #VIS_G4_VOLUMES_BUILD_DLL is defined, imported
         if #VIS_G4_VOLUMES_BUILD_ARCHIVE is not defined, and left
	 alone if latter is defined (for an archive library build).  */

/** @def VIS_G4_VOLUMES_BUILD_DLL
  @brief Indicates that the header is included during the build of
         a shared library of this package, and all entities marked
	 with #VIS_G4_VOLUMES_API should be exported.  */

/** @def VIS_G4_VOLUMES_BUILD_ARCHIVE
  @brief Indicates that this library is or was built as an archive
	 ...
	 #VIS_G4_VOLUMES_API should be imported.  */

# ifndef VIS_G4_VOLUMES_API
#  ifdef _WIN32
#   if defined VIS_G4_VOLUMES_BUILD_DLL
#    define VIS_G4_VOLUMES_API __declspec(dllexport)
#   elif ! defined VIS_G4_VOLUMES_BUILD_ARCHIVE
#    define VIS_G4_VOLUMES_API __declspec(dllimport)
#   endif
#  endif
# endif

# ifndef VIS_G4_VOLUMES_API
#  define VIS_G4_VOLUMES_API
# endif

#endif // VIS_G4_VOLUMES_CONFIG_H
