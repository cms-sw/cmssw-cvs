...
XTYPEINFO_DEF_1 (Ig2DModel, Ig3DBaseModel, false);
XTYPEINFO_DEF_1 (Ig2DRep,   Ig3DBaseRep, false);
XTYPEINFO_DEF_1 (Ig3DBaseModel, IgModel, false);
XTYPEINFO_DEF_1 (Ig3DBaseRep,   IgRep, false);
XTYPEINFO_DEF_1 (Ig3DModel, Ig3DBaseModel, false);
XTYPEINFO_DEF_1 (Ig3DRep,   Ig3DBaseRep, false);
XTYPEINFO_DEF_1 (IgLegoModel, Ig3DBaseModel, false);
XTYPEINFO_DEF_1 (IgLegoRep,   Ig3DBaseRep, false);
XTYPEINFO_DEF_1 (IgRPhiModel, Ig3DBaseModel, false);
XTYPEINFO_DEF_1 (IgRPhiRep,   Ig3DBaseRep, false);
XTYPEINFO_DEF_1 (IgRZModel, Ig3DBaseModel, false);
XTYPEINFO_DEF_1 (IgRZRep,   Ig3DBaseRep, false);
XTYPEINFO_DEF_1 (IgSpareModel, Ig3DBaseModel, false);
XTYPEINFO_DEF_1 (IgSpareRep,   Ig3DBaseRep, false);
...
//////////////////////////////////////////////////////////////////////
MMM_DEFUN_FUNC(IgRepContext *, IgBrowserMethods::,doRepresent,
	       (IgTwig *twig, IgSpareModel *model))
{
    LOG (0, trace, LFcommon3d, "doRepresent(IgTwig[" << twig->name ()
	 << "],IgSpareModel)\n" << lat::indent);
    ...
    // classes should add the actual representation.
    SoSwitch	*node = new SoSwitch;
    node->setName (IgSpareModel::encode (twig->name ()));
    node->whichChild = twig->visible () ? SO_SWITCH_ALL : SO_SWITCH_NONE;

    IgRepContext *context
	= new IgRepContext (twig, new IgSpareRep (model,
						 static_cast<IgSpareRep *> (prep),
						 static_cast<IgSpareRep *> (prev),
						 node));
