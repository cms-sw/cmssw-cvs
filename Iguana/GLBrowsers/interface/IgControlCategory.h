#ifndef IGUANA_GL_BROWSERS_IG_CONTROL_CATEGORY_H
# define IGUANA_GL_BROWSERS_IG_CONTROL_CATEGORY_H
...
class IGUANA_GL_BROWSERS_API IgControlCategory : public IgControlItem
{
  Q_OBJECT
public:
  enum {
...
#endif // IGUANA_GL_BROWSERS_IG_CONTROL_CATEGORY_H
