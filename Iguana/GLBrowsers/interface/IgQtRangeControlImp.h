#ifndef IGUANA_GL_BROWSERS_IG_QT_RANGE_CONTROL_IMP_H
# define IGUANA_GL_BROWSERS_IG_QT_RANGE_CONTROL_IMP_H
...
template <class T>
class IGUANA_GL_BROWSERS_API IgQtRangeControlImp : public IgQtRangeControl, public IgQtRangeValue<T>
{
public:
...
#endif // IGUANA_GL_BROWSERS_IG_QT_RANGE_CONTROL_IMP_H
