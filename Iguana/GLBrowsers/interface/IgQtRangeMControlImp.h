#ifndef IGUANA_GL_BROWSERS_IG_QT_RANGE_MCONTROL_IMP_H
# define IGUANA_GL_BROWSERS_IG_QT_RANGE_MCONTROL_IMP_H
...
template <class T>
class IGUANA_GL_BROWSERS_API IgQtRangeMControlImp : public IgQtRangeMControl, public IgQtRangeMValue<T>
{
public:
    ...
    {
      IgQtRangeMValue<T>::myReSize (size, appendedValues);
...
#endif // IGUANA_GL_BROWSERS_IG_QT_RANGE_MCONTROL_IMP_H
