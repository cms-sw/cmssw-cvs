#ifndef IGUANA_GL_BROWSERS_IG_QT_RANGE_VALUE_H
# define IGUANA_GL_BROWSERS_IG_QT_RANGE_VALUE_H
...
template<class T>
class IGUANA_GL_BROWSERS_API IgQtRangeValue
{
public:
...
#endif // IGUANA_GL_BROWSERS_IG_QT_RANGE_VALUE_H
