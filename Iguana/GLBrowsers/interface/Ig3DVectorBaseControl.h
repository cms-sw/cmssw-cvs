#ifndef IGUANA_GL_BROWSERS_IG_3DVECTOR_BASE_CONTROL_H
# define IGUANA_GL_BROWSERS_IG_3DVECTOR_BASE_CONTROL_H
...
class IGUANA_GL_BROWSERS_API Ig3DVectorBaseControl : public Ig3DFieldControl
{
    Q_OBJECT
public:
    enum Style {
...
#endif // IGUANA_GL_BROWSERS_IG_3DVECTOR_BASE_CONTROL_H
