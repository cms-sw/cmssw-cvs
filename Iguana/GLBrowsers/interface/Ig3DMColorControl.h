#ifndef IGUANA_GL_BROWSERS_IG_3DMCOLOR_CONTROL_H
# define IGUANA_GL_BROWSERS_IG_3DMCOLOR_CONTROL_H
...
class IGUANA_GL_BROWSERS_API Ig3DMColorControl : public Ig3DFieldControl
{
    Q_OBJECT
public:
...
#endif // IGUANA_GL_BROWSERS_IG_3DMCOLOR_CONTROL_H
