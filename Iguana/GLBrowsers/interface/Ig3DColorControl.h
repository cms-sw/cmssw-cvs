#ifndef IGUANA_GL_BROWSERS_IG_3DCOLOR_CONTROL_H
# define IGUANA_GL_BROWSERS_IG_3DCOLOR_CONTROL_H
...
class IGUANA_GL_BROWSERS_API Ig3DColorControl : public Ig3DFieldControl
{
    Q_OBJECT
public:
...
#endif // IGUANA_GL_BROWSERS_IG_3DCOLOR_CONTROL_H
