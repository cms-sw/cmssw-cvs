...
IgQtRangeSetting::IgQtRangeSetting (QWidget* parent, const char* name, bool modal, Qt::WFlags fl)
      ...
      m_applied (false)
{
    ...
    m_precision->setAlignment (Qt::AlignRight);
    ...
    m_small->setAlignment (Qt::AlignRight);
    ...
    m_long->setAlignment (Qt::AlignRight);
