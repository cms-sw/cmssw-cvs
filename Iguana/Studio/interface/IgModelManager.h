#ifndef IGUANA_STUDIO_IG_MODEL_MANAGER_H
# define IGUANA_STUDIO_IG_MODEL_MANAGER_H
...
class IGUANA_STUDIO_API IgModelManager : public IgStateElement
{
...
#endif // IGUANA_STUDIO_IG_MODEL_MANAGER_H
