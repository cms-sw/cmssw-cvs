#ifndef IGUANA_STUDIO_CONFIG_H
# define IGUANA_STUDIO_CONFIG_H
...
/** @def IGUANA_STUDIO_API
    ...
    exported if #IGUANA_STUDIO_BUILD_DLL is defined, imported
    if #IGUANA_STUDIO_BUILD_ARCHIVE is not defined, and left
    alone if latter is defined (for an archive library build).  */

/** @def IGUANA_STUDIO_BUILD_DLL
    @brief Indicates that the header is included during the build of
    a shared library of this package, and all entities marked
    with #IGUANA_STUDIO_API should be exported.  */

/** @def IGUANA_STUDIO_BUILD_ARCHIVE
    ...
    #IGUANA_STUDIO_API should be imported.  */

# ifndef IGUANA_STUDIO_API
#  ifdef _WIN32
#   if defined IGUANA_STUDIO_BUILD_DLL
#    define IGUANA_STUDIO_API __declspec(dllexport)
#   elif ! defined IGUANA_STUDIO_BUILD_ARCHIVE
#    define IGUANA_STUDIO_API __declspec(dllimport)
#   endif
#  endif
# endif

# ifndef IGUANA_STUDIO_API
#  define IGUANA_STUDIO_API
# endif

#endif // IGUANA_STUDIO_CONFIG_H
