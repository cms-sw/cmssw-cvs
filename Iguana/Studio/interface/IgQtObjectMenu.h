#ifndef IGUANA_STUDIO_IG_QT_OBJECT_MENU_H
# define IGUANA_STUDIO_IG_QT_OBJECT_MENU_H
...
class IGUANA_STUDIO_API IgQtObjectMenu
{
public:
    struct ItemDef
    {
    ...
    IgQtObjectMenu *		insertSubMenu (int id, const QIcon &icon,
					       const QString &text);
    ...
    int				insertItem (int id, const QIcon &icon,
					    const QString &text);
    ...
    void			changeItem (int id, const QIcon &icon, const QPixmap &pixmap);
...
#endif // IGUANA_STUDIO_IG_QT_OBJECT_MENU_H
