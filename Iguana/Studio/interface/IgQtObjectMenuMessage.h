#ifndef IGUANA_STUDIO_IG_QT_OBJECT_MENU_MESSAGE_H
# define IGUANA_STUDIO_IG_QT_OBJECT_MENU_MESSAGE_H
...
/** A message notifying that a context-sensitive menu for an object
    ...
    selection?)  */
class IGUANA_STUDIO_API IgQtObjectMenuMessage
{
public:
...
#endif // IGUANA_STUDIO_IG_QT_OBJECT_MENU_MESSAGE_H
