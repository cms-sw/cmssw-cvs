...
//  $Id: IgSoQtThumbWheel.h,v 1.4 2010/07/02 09:40:49 yana Exp $
...
class IGUANA_STUDIO_API IgSoQtThumbWheel : public QAbstractSlider
{
  Q_OBJECT
...
public:
  ...
  IgSoQtThumbWheel( Qt::Orientation, QWidget * parent = 0, const char * name = 0 );
...
private:
  void constructor( Qt::Orientation );
