...
static const char rcsid[] =
  "$Id: IgSoQtThumbWheel.cpp,v 1.4 2010/07/02 09:40:49 yana Exp $";
#endif // SOQT_DEBUG
...
#include "Iguana/Studio/interface/IgSoAnyThumbWheel.h"
  ...
  int width )
{
  ...
  for ( int i = 0; i < this->numPixmaps; i++ ) {
    this->wheel->drawBitmap( i, image.bits(), (this->orient == Qt::Vertical) ?
