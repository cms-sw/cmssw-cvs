	...
	m_gridPlane (0)
{
	...
	m_curCorner[LL].setValue (-1.,0.,-1.);
	m_curCorner[LR].setValue (1.,0.,-1.);
	m_curCorner[UL].setValue (-1.,0., 1.);
	
	labelSpot[LL].setValue (-1.,0.,-1.);
	labelSpot[LR].setValue (1.,0.,-1.);
	labelSpot[UL].setValue (-1.,0., 1.);
}
