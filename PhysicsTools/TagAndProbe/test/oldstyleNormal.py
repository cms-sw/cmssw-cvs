...
process.MakeHisto = cms.EDAnalyzer("TagProbeEDMAnalysis",      
      ...
      FitFileName = cms.untracked.string( "fit_onestep.root" ),
      ...
      NumSignal         = cms.untracked.vdouble( 200.0,0.0, 30000.0 ),    
      NumBkgPass        = cms.untracked.vdouble( 20.0,0.0,  10000.0 ),    
      NumBkgFail        = cms.untracked.vdouble( 20.0,0.0,   7000.0 ),    
...
process.TFileService = cms.Service("TFileService", fileName = cms.string("testNormal.root"))
