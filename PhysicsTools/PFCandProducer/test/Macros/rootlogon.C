...
void initPAT(const char* process) {
  string taus = "patTaus_selectedLayer1Taus__"; taus += process;
  string jets = "patJets_selectedLayer1Jets__"; jets += process;
  string met = "patMETs_layer1METs__";  met+= process;
  string mus = "patMuons_selectedLayer1Muons__"; mus += process;
  string eles = "patElectrons_selectedLayer1Electrons__"; eles += process;
