...
process.configurationMetadata = cms.untracked.PSet(
    ...
    name = cms.untracked.string('$Source: /afs/cern.ch/work/c/cmsbuild/public/cvs/CMSSW/CMSSW/Configuration/Skimming/python/Attic/PDElectron_Skims3_cfg.py,v $'),
...
process.EgammaAnalysis = cms.EndPath(process.egammaZPlusEMOrJetOutputModuleAODSIM+process.egammaZPlusEMOrJetOutputModuleRECOSIM)
