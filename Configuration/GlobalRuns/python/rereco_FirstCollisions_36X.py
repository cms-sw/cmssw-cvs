...
process.offlinePrimaryVerticesWithBS.TkClusParameters.TkGapClusParameters.zSeparation = 10
...
process.offlinePrimaryVertices.TkClusParameters.TkGapClusParameters.zSeparation = 10
