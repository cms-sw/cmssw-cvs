...
# with command line options: alCaRecoSplitting -s ALCAOUTPUT:SiStripCalZeroBias+TkAlMinBias+MuAlCalIsolatedMu+DtCalib --conditions FrontierConditions_GlobalTag,GR10_P_V6::All --no_exec --triggerResultsProcess RECO --filein=/store/temp/data/Commissioning10/MinimumBias/ALCARECO/v9/000/135/528/26F91E4B-C160-DF11-A588-003048D37456.root --no_output --python_filename=alCaRecoSplitting_express_cfg.py --data
...
process.source = cms.Source("PoolSource",
    fileNames = cms.untracked.vstring('file:/build/cerminar/GlobalTag/Validation/2010-05-21/CMSSW_3_6_1_patch1/src/Configuration/GlobalRuns/python/expressReco_RAW2DIGI_L1Reco_RECO_DQM_ALCAPRODUCER_secondary.root')
)
...
# Schedule definition
process.schedule = cms.Schedule(process.ALCARECOStreamTkAlMinBiasOutPath,process.ALCARECOStreamMuAlCalIsolatedMuOutPath,process.ALCARECOStreamDtCalibOutPath,process.ALCARECOStreamSiStripCalZeroBiasOutPath)
