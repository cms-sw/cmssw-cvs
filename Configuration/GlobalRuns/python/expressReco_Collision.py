...
# with command line options: expressReco -s RAW2DIGI,L1Reco,RECO,DQM,ALCAPRODUCER:SiStripCalZeroBias+TkAlMinBias+MuAlCalIsolatedMu+DtCalib --data --magField AutoFromDBCurrent --scenario pp --datatier RECO --eventcontent RECO,ALCARECO --conditions GR10_P_V6::All --customise Configuration/GlobalRuns/reco_TLR_36X.py --no_exec --python_filename=expressReco_Collision.py --custFcn customiseExpress --geometry DB
