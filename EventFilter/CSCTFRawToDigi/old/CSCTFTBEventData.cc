...
// Created:     13.1.2005
//
// $Id: CSCTFTBEventData.cc,v 1.1 2007/04/26 23:39:19 kkotov Exp $
//
// Revision History
// $Log: CSCTFTBEventData.cc,v $
// Revision 1.1  2007/04/26 23:39:19  kkotov
//
// Moved old TB data format to a separate folder, attempted to unpack status digi
//
...
static const char* const kIdString  = "$Id: CSCTFTBEventData.cc,v 1.1 2007/04/26 23:39:19 kkotov Exp $";
static const char* const kTagString = "$Name: V02-17-05-02 $";
