...
process.configurationMetadata = cms.untracked.PSet(
    ...
    name = cms.untracked.string('$Source: /cvs_server/repositories/CMSSW/CMSSW/SimGeneral/DataMixingModule/python/supplementary/recoT0DQM_EvContent_40T_digiOnly_cfg.py,v $'),
