...
eeecalshifterlayout(dqmitems, "07 Selective Readout/00 EventSize",
  [{ 'path': "$prefix/EESelectiveReadoutTask/EESRT event size EE -", 'description': "Event size for the readout crystals in the ECAL endcap.  The averaged event size must be below 100kB. <a href=https://twiki.cern.ch/twiki/bin/view/CMS/DQMShiftEcalExpert>DQMShiftEcalExpert</a>", 'draw': { 'withref': "yes" } }],
  [{ 'path': "$prefix/EESelectiveReadoutTask/EESRT event size EE +", 'description': "Event size for the readout crystals in the ECAL endcap.  The averaged event size must be below 100kB. <a href=https://twiki.cern.ch/twiki/bin/view/CMS/DQMShiftEcalExpert>DQMShiftEcalExpert</a>", 'draw': { 'withref': "yes" } }])

eeecalshifterlayout(dqmitems, "07 Selective Readout/01 DCC EventSize",
...
eeecalshifterlayout(dqmitems, "07 Selective Readout/02 ReadoutUnitSRForced",
  [{ 'path': "$prefix/EESelectiveReadoutTask/EESRT readout unit with SR forced EE -", 'description': "Trigger tower flag forced bit. Rate at which a trigger tower flag was forced either by configuration or following to an error. In current online configuration, the flag is forced to low interest. <a href=https://twiki.cern.ch/twiki/bin/view/CMS/DQMShiftEcalExpert>DQMShiftEcalExpert</a>" }],
  [{ 'path': "$prefix/EESelectiveReadoutTask/EESRT readout unit with SR forced EE +", 'description': "Trigger tower flag forced bit. Rate at which a trigger tower flag was forced either by configuration or following to an error. In current online configuration, the flag is forced to low interest. <a href=https://twiki.cern.ch/twiki/bin/view/CMS/DQMShiftEcalExpert>DQMShiftEcalExpert</a>" }])

eeecalshifterlayout(dqmitems, "07 Selective Readout/03 FullReadout",
...
eeecalshifterlayout(dqmitems, "07 Selective Readout/04 HighInterestTTFlags",
  [{ 'path': "$prefix/EESelectiveReadoutTask/EESRT high interest TT Flags EE -", 'description': "HI Trigger Tower Flag. Rate of high-interest flag for each trigger tower. A high-interest flag triggers the readout of a 3x3 trigger tower region (which in the endcap is extended to a larger region made of complete readout unit). <a href=https://twiki.cern.ch/twiki/bin/view/CMS/DQMShiftEcalExpert>DQMShiftEcalExpert</a>" }],
  [{ 'path': "$prefix/EESelectiveReadoutTask/EESRT high interest TT Flags EE +", 'description': "HI Trigger Tower Flag. Rate of high-interest flag for each trigger tower. A high-interest flag triggers the readout of a 3x3 trigger tower region (which in the endcap is extended to a larger region made of complete readout unit). <a href=https://twiki.cern.ch/twiki/bin/view/CMS/DQMShiftEcalExpert>DQMShiftEcalExpert</a>" }])

eeecalshifterlayout(dqmitems, "07 Selective Readout/05 LowInterestTTFlags",
  [{ 'path': "$prefix/EESelectiveReadoutTask/EESRT low interest TT Flags EE -", 'description': "Low Interest Trigger Tower Flag. Rate of low-interest flag for each trigger tower. <a href=https://twiki.cern.ch/twiki/bin/view/CMS/DQMShiftEcalExpert>DQMShiftEcalExpert</a>" }],
  [{ 'path': "$prefix/EESelectiveReadoutTask/EESRT low interest TT Flags EE +", 'description': "Low Interest Trigger Tower Flag. Rate of low-interest flag for each trigger tower. <a href=https://twiki.cern.ch/twiki/bin/view/CMS/DQMShiftEcalExpert>DQMShiftEcalExpert</a>" }])

eeecalshifterlayout(dqmitems, "07 Selective Readout/07 HighInterestPayload",
  [{ 'path': "$prefix/EESelectiveReadoutTask/EESRT high interest payload EE -", 'description': "Endcap - HI payload. Size of barrel crystal-channel data in high interest region within the ECAL event. <a href=https://twiki.cern.ch/twiki/bin/view/CMS/DQMShiftEcalExpert>DQMShiftEcalExpert</a>", 'draw': { 'withref': "yes" } }],
  [{ 'path': "$prefix/EESelectiveReadoutTask/EESRT high interest payload EE +", 'description': "Endcap + HI payload. Size of barrel crystal-channel data in high interest region within the ECAL event. <a href=https://twiki.cern.ch/twiki/bin/view/CMS/DQMShiftEcalExpert>DQMShiftEcalExpert</a>", 'draw': { 'withref': "yes" } }])

eeecalshifterlayout(dqmitems, "07 Selective Readout/08 LowInterestPayload",
  [{ 'path': "$prefix/EESelectiveReadoutTask/EESRT low interest payload EE -", 'description': "Endcap - LI payload. Size of barrel crystal-channel data in high interest region within the ECAL event. <a href=https://twiki.cern.ch/twiki/bin/view/CMS/DQMShiftEcalExpert>DQMShiftEcalExpert</a>", 'draw': { 'withref': "yes" } }],
  [{ 'path': "$prefix/EESelectiveReadoutTask/EESRT low interest payload EE +", 'description': "Endcap - LI payload. Size of barrel crystal-channel data in high interest region within the ECAL event. <a href=https://twiki.cern.ch/twiki/bin/view/CMS/DQMShiftEcalExpert>DQMShiftEcalExpert</a>", 'draw': { 'withref': "yes" } }])

eeecalshifterlayout(dqmitems, "07 Selective Readout/09 TowerSize",
...
eeecalshifterlayout(dqmitems, "07 Selective Readout/10 ZSFilterOutput HighInterest",
...
eeecalshifterlayout(dqmitems, "07 Selective Readout/11 ZSFilterOutput LowInterest",
