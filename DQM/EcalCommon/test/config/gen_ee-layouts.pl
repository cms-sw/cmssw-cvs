...
eeecalshifterlayout(dqmitems, "04 Energy/00 RecHit Energy Spectrum",
  [{ 'path': "$prefix/EEOccupancyTask/EEOT rec hit spectrum EE -", 'description': "Average energy of good (rechit quality flag and channel status) calibrated rechits. Physics events only. <a href=https://twiki.cern.ch/twiki/bin/view/CMS/DQMShiftEcalExpert>DQMShiftEcalExpert</a>" }],
  [{ 'path': "$prefix/EEOccupancyTask/EEOT rec hit spectrum EE +", 'description': "Average energy of good (rechit quality flag and channel status) calibrated rechits. Physics events only. <a href=https://twiki.cern.ch/twiki/bin/view/CMS/DQMShiftEcalExpert>DQMShiftEcalExpert</a>" }])
...
eeecalshifterlayout(dqmitems, "05 Timing/00 Timing Summary",
  [{ 'path': "$prefix/EESummaryClient/EETMT EE - timing quality summary", 'description': "Quality summary of the calibrated reconstructed hits in EE -. Calibrated rechits are used with E_T > 600 MeV, good DB status and rechit flag = kGood OR KOutOfTime. Hardware timing is adjusted with readout tower granularity, but finer setting can be reached. Expected all green color. Legend: green = good;  red = bad;  yellow = no sufficient statistics.  <a href=https://twiki.cern.ch/twiki/bin/view/CMS/DQMShiftEcal>DQMShiftEcal</a>" }],
  [{ 'path': "$prefix/EESummaryClient/EETMT EE + timing quality summary", 'description': "Quality summary of the calibrated reconstructed hits in EE +. Calibrated rechits are used with E_T > 600 MeV, good DB status and rechit flag = kGood OR KOutOfTime. Hardware timing is adjusted with readout tower granularity, but finer setting can be reached. Expected all green color. Legend: green = good;  red = bad;  yellow = no sufficient statistics.  <a href=https://twiki.cern.ch/twiki/bin/view/CMS/DQMShiftEcal>DQMShiftEcal</a>" }])
...
eeecalshifterlayout(dqmitems, "07 Calibration/00 Laser/00 $color Laser (L$laser) Quality",
...
eeecalshifterlayout(dqmitems, "07 Calibration/00 Laser/01 $color Laser (L$laser) Errors",
...
eeecalshifterlayout(dqmitems, "07 Calibration/00 Laser/02 $color Laser (L$laser) Amplitude",
...
eeecalshifterlayout(dqmitems, "07 Calibration/00 Laser/03 $color Laser (L$laser) Timing",
...
eeecalshifterlayout(dqmitems, "07 Calibration/00 Laser/04 $color Laser (L$laser) PNQuality",
