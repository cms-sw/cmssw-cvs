...
eeshifterlayout(dqmitems, "12 DCC EventSize",
  [{ 'path': "$prefix/EESelectiveReadoutTask/EESRT DCC event size", 'description': "Average event size per ecah ECAL endcap DCC calculated only on physics events. Expected about 2 kB/DCC. <a href=https://twiki.cern.ch/twiki/bin/view/CMS/DQMShiftEcal>DQMShiftEcal</a>", 'draw': { 'withref': "yes" } }],
  [None])
...
eeecalshifterlayout(dqmitems, "01 Electronics/02 PN Integrity Summary",
  [{ 'path': "$prefix/EESummaryClient/EEIT PN integrity quality summary", 'description': "Quality summary checking that data for each PN diode follows all the formatting rules and all the constraints which are dictated by the design of the electronics. Expected all green color. Legend: green = good;  red = bad;  yellow = no entries; white means that no MEM is attached to that DCC (by the readout point of view).  Quality criteria: each crystal is required to have integrity errors in less than 1% of events. <a href=https://twiki.cern.ch/twiki/bin/view/CMS/DQMShiftEcalExpert>DQMShiftEcalExpert</a>" }],
  [None])
...
eeecalshifterlayout(dqmitems, "01 Electronics/04 DCC - FE Synchronization",
...
eeecalshifterlayout(dqmitems, "02 Noise/00 PedestalOnline Quality",
  [{ 'path': "$prefix/EESummaryClient/EEPOT EE - pedestal quality summary G12", 'description': "Pedestal quality summary. Pedestal is evaluated using the first 3/10 samples of the pulse shape for all the events (on physics events only). Expected all green color. Legend: green = good;  red = bad;  yellow = no entries. Quality criteria: 175 < mean < 225 ADCs, RMS < 4 ADCs <a href=https://twiki.cern.ch/twiki/bin/view/CMS/DQMShiftEcalExpert>DQMShiftEcalExpert</a>" }],
  [{ 'path': "$prefix/EESummaryClient/EEPOT EE + pedestal quality summary G12", 'description': "pedestal quality summary. Pedestal is evaluated using the first 3/10 samples of the pulse shape for all the events (on physics events only). Expected all green color. Legend: green = good;  red = bad;  yellow = no entries. Quality criteria: 175 < mean < 225 ADCs, RMS < 4 ADCs. <a href=https://twiki.cern.ch/twiki/bin/view/CMS/DQMShiftEcalExpert>DQMShiftEcalExpert</a>" }])
...
eeecalshifterlayout(dqmitems, "04 Energy/00 RecHit Energy Spectrum",
  [{ 'path': "$prefix/EEOccupancyTask/EEOT rec hit spectrum EE -", 'description': "Average energy of good (rechit quality flag and channel status) calibrated rechits. Physics events only. <a href=https://twiki.cern.ch/twiki/bin/view/CMS/DQMShiftEcalExpert>DQMShiftEcalExpert</a>", 'draw': { 'withref': "yes" } }],
  [{ 'path': "$prefix/EEOccupancyTask/EEOT rec hit spectrum EE +", 'description': "Average energy of good (rechit quality flag and channel status) calibrated rechits. Physics events only. <a href=https://twiki.cern.ch/twiki/bin/view/CMS/DQMShiftEcalExpert>DQMShiftEcalExpert</a>", 'draw': { 'withref': "yes" } }])
...
eeecalshifterlayout(dqmitems, "04 Energy/07 Basic Cluster Shape",
  [{ 'path': "$prefix/EEClusterTask/EECLT s1s9", 'description': "Ratio of E(max)/E(3x3) of all basic clusters. <a href=https://twiki.cern.ch/twiki/bin/view/CMS/DQMShiftEcalExpert>DQMShiftEcalExpert</a>", 'draw': { 'withref': "yes" } }],
  [{ 'path': "$prefix/EEClusterTask/EECLT s1s9 thr", 'description': "Ratio of E(max)/E(3x3) of basic clusters with a seed crystal with E>3.0 GeV. <a href=https://twiki.cern.ch/twiki/bin/view/CMS/DQMShiftEcalExpert>DQMShiftEcalExpert</a>", 'draw': { 'withref': "yes" } }])

eeecalshifterlayout(dqmitems, "04 Energy/08 SuperClusters 1D",
...
eeecalshifterlayout(dqmitems, "04 Energy/09 Peaks",
...
eeecalshifterlayout(dqmitems, "05 Timing/00 Timing Summary",
  [{ 'path': "$prefix/EESummaryClient/EETMT EE - timing quality summary", 'description': "Quality summary of the calibrated reconstructed hits in EE -. Hardware timing is adjusted with readout tower granularity, but finer setting can be reached. Expected all green color. Legend: green = good;  red = bad;  yellow = no sufficient statistics. Quality criteria: Average timing in each crystal for calibrated rechits with transverse energy ET>600 MeV, good DB status and rechit flag = kGood OR KOutOfTime is evaluated if more than 2 hits pass the above cuts. The following criteria are applied: -25 < mean < 25 ns and RMS < 125 ns.  <a href=https://twiki.cern.ch/twiki/bin/view/CMS/DQMShiftEcal>DQMShiftEcal</a>" }],
  [{ 'path': "$prefix/EESummaryClient/EETMT EE + timing quality summary", 'description': "Quality summary of the calibrated reconstructed hits in EE +. Hardware timing is adjusted with readout tower granularity, but finer setting can be reached. Expected all green color. Legend: green = good;  red = bad;  yellow = no sufficient statistics. Quality criteria: Average timing in each crystal for calibrated rechits with transverse energy ET>600 MeV, good DB status and rechit flag = kGood OR KOutOfTime is evaluated if more than 2 hits pass the above cuts. The following criteria are applied: -25 < mean < 25 ns and RMS < 125 ns. <a href=https://twiki.cern.ch/twiki/bin/view/CMS/DQMShiftEcal>DQMShiftEcal</a>" }])

eeecalshifterlayout(dqmitems, "05 Timing/01 Timing Mean",
  [{ 'path': "$prefix/EESummaryClient/EETMT EE - timing mean 1D summary", 'description': "Mean timing of all the channels in EE -. Timing is expected around 0 ns. Calibrated rechits are used with E_T > 600 MeV, good DB status and rechit flag = kGood OR KOutOfTime. <a href=https://twiki.cern.ch/twiki/bin/view/CMS/DQMShiftEcalExpert>DQMShiftEcalExpert</a>", 'draw': { 'withref': "yes" } },
   { 'path': "$prefix/EESummaryClient/EETMT EE + timing mean 1D summary", 'description': "Mean timing of all the channels in EE +. Timing is expected around 0 ns. Calibrated rechits are used with E_T > 600 MeV, good DB status and rechit flag = kGood OR KOutOfTime. <a href=https://twiki.cern.ch/twiki/bin/view/CMS/DQMShiftEcalExpert>DQMShiftEcalExpert</a>", 'draw': { 'withref': "yes" } }],
  [{ 'path': "$prefix/EESummaryClient/EETMT timing mean", 'description': "Mean timing of all the channels in each DCC of EE. Timing is expected around 0 ns. Calibrated rechits are used with E_T > 600 MeV, good DB status and rechit flag = kGood OR KOutOfTime. The error bar represents the spreads among the crystal of each DCC. <a href=https://twiki.cern.ch/twiki/bin/view/CMS/DQMShiftEcalExpert>DQMShiftEcalExpert</a>", 'draw': { 'withref': "yes" } }])

eeecalshifterlayout(dqmitems, "05 Timing/02 Timing RMS",
  [{ 'path': "$prefix/EESummaryClient/EETMT EE - timing rms 1D summary", 'description': "Timing RMS of all the channels in EE -. Timing RMS is expected < 10 ns. Calibrated rechits are used with E_T > 600 MeV, good DB status and rechit flag = kGood OR KOutOfTime. <a href=https://twiki.cern.ch/twiki/bin/view/CMS/DQMShiftEcalExpert>DQMShiftEcalExpert</a>", 'draw': { 'withref': "yes" } },
   { 'path': "$prefix/EESummaryClient/EETMT EE + timing rms 1D summary", 'description': "Timing RMS of all the channels in EE +. Timing RMS is expected < 10 ns. Calibrated rechits are used with E_T > 600 MeV, good DB status and rechit flag = kGood OR KOutOfTime. <a href=https://twiki.cern.ch/twiki/bin/view/CMS/DQMShiftEcalExpert>DQMShiftEcalExpert</a>", 'draw': { 'withref': "yes" } }],
  [{ 'path': "$prefix/EESummaryClient/EETMT timing rms", 'description': "Timing RMS of all the channels in each DCC of EE. Calibrated rechits are used with E_T > 600 MeV, good DB status and rechit flag = kGood OR KOutOfTime. The error bar represents the spreads among the crystal of each DCC. <a href=https://twiki.cern.ch/twiki/bin/view/CMS/DQMShiftEcalExpert>DQMShiftEcalExpert</a>", 'draw': { 'withref': "yes" } }])

eeecalshifterlayout(dqmitems, "05 Timing/03 Timing Map EE -",
  [{ 'path': "$prefix/EETimingTask/EETMT timing map EE -", 'description': "Average timing of the good calibrated rechits. Expected around 0 ns. Calibrated rechits are used with E_T > 600 MeV, good DB status and rechit flag = kGood OR KOutOfTime. Readout tower binning (5x5 crystals) is used. <a href=https://twiki.cern.ch/twiki/bin/view/CMS/DQMShiftEcalExpert>DQMShiftEcalExpert</a>", 'draw': { 'withref': "yes" } }],
  [{ 'path': "$prefix/EETimingTask/EETMT timing projection eta EE -", 'description': "Average timing of the good calibrated rechits. Expected around 0 ns. Calibrated rechits are used with E_T > 600 MeV, good DB status and rechit flag = kGood OR KOutOfTime. Readout tower binning (5x5 crystals) is used. <a href=https://twiki.cern.ch/twiki/bin/view/CMS/DQMShiftEcalExpert>DQMShiftEcalExpert</a>", 'draw': { 'withref': "yes" } },
   { 'path': "$prefix/EETimingTask/EETMT timing projection phi EE -", 'description': "Average timing of the good calibrated rechits. Expected around 0 ns. Calibrated rechits are used with E_T > 600 MeV, good DB status and rechit flag = kGood OR KOutOfTime. Readout tower binning (5x5 crystals) is used. <a href=https://twiki.cern.ch/twiki/bin/view/CMS/DQMShiftEcalExpert>DQMShiftEcalExpert</a>", 'draw': { 'withref': "yes" } }])
...
eeecalshifterlayout(dqmitems, "05 Timing/04 Timing Vs Amplitude EE",
  [{ 'path': "$prefix/EETimingTask/EETMT timing vs amplitude summary EE +", 'description': "Average timing of the good calibrated rechits. Expected around 0 ns. Calibrated rechits are used with good DB status and rechit flag = kGood OR KOutOfTime. Readout tower binning (5x5 crystals) is used. <a href=https://twiki.cern.ch/twiki/bin/view/CMS/DQMShiftEcalExpert>DQMShiftEcalExpert</a>", 'draw': { 'withref': "yes" } }],
  [{ 'path': "$prefix/EETimingTask/EETMT timing vs amplitude summary EE -", 'description': "Average timing of the good rechits. Expected around 0 ns. Calibrated rechits are used with good DB status and rechit flag = kGood OR KOutOfTime. Readout tower binning (5x5 crystals) is used. <a href=https://twiki.cern.ch/twiki/bin/view/CMS/DQMShiftEcalExpert>DQMShiftEcalExpert</a>", 'draw': { 'withref': "yes" } }])

eeecalshifterlayout(dqmitems, "05 Timing/04 Single Event Timing",
  [{ 'path': "$prefix/EETimingTask/EETMT timing 1D summary EE -", 'description': "Single event timing of the good calibrated rechits. Expected around 0 ns. Calibrated rechits are used with E_T > 600 MeV, good DB status and rechit flag = kGood OR KOutOfTime. <a href=https://twiki.cern.ch/twiki/bin/view/CMS/DQMShiftEcalExpert>DQMShiftEcalExpert</a>", 'draw': { 'withref': "yes" } },
   { 'path': "$prefix/EETimingTask/EETMT timing 1D summary EE +", 'description': "Single event timing of the good calibrated rechits. Expected around 0 ns. Calibrated rechits are used with E_T > 600 MeV, good DB status and rechit flag = kGood OR KOutOfTime. <a href=https://twiki.cern.ch/twiki/bin/view/CMS/DQMShiftEcalExpert>DQMShiftEcalExpert</a>", 'draw': { 'withref': "yes" } }],
  [{ 'path': "$prefix/EETimingTask/EETMT timing EE+ - EE-", 'description': "Event by event difference between the average timing in EE+ and EE- of the good rechits. Expected 0. Required in each endcap one crystal with E_T > 300 MeV and one crystal with E_T > 600 MeV, good DB status and rechit flag = kGood OR KOutOfTime. <a href=https://twiki.cern.ch/twiki/bin/view/CMS/DQMShiftEcalExpert>DQMShiftEcalExpert</a>", 'draw': { 'withref': "yes" } },
   { 'path': "$prefix/EETimingTask/EETMT timing EE+ vs EE-", 'description': "Average timing in EE- vs average timing in EE+. Only rechits with ET>600 MeV and kGood or kOutOfTime considered here. Expect one spot centered in (0,0) for collisions, two spots in (0,-20), (-20,0) for beam-halos. <a href=https://twiki.cern.ch/twiki/bin/view/CMS/DQMShiftEcalExpert>DQMShiftEcalExpert</a>", 'draw': { 'withref': "yes" } }])
...
eeecalshifterlayout(dqmitems, "06 L1 Trigger/01 TriggerPrimitives ET",
...
eeecalshifterlayout(dqmitems, "06 L1 Trigger/02 Trigger Primitives Occupancy (Threshold) EE -",
  [{ 'path': "$prefix/EEOccupancyTask/EEOT TP digi thr occupancy EE -", 'description': "Map of the occupancy of ECAL trigger primitives with an E_T > 1 GeV (4 ADC counts). Darker regions mean noisy towers. Physics events only. <a href=https://twiki.cern.ch/twiki/bin/view/CMS/DQMShiftEcalExpert>DQMShiftEcalExpert</a>" }],
  [{ 'path': "$prefix/EEOccupancyTask/EEOT TP digi thr occupancy EE - projection eta", 'description': "Eta projection of the occupancy of ECAL trigger primitives with an E_T > 1 GeV (4 ADC counts). Expect uniform distribution, spikes mean noisy towers. Physics events only. <a href=https://twiki.cern.ch/twiki/bin/view/CMS/DQMShiftEcalExpert>DQMShiftEcalExpert</a>", 'draw': { 'withref': "yes" } },
   { 'path': "$prefix/EEOccupancyTask/EEOT TP digi thr occupancy EE - projection phi", 'description': "Phi projection of the occupancy of ECAL trigger primitives with an E_T > 1 GeV (4 ADC counts). Expect uniform distribution, spikes mean noisy towers. Physics events only. <a href=https://twiki.cern.ch/twiki/bin/view/CMS/DQMShiftEcalExpert>DQMShiftEcalExpert</a>", 'draw': { 'withref': "yes" } }])
...
eeecalshifterlayout(dqmitems, "06 L1 Trigger/03 TP data matching Emulator EE -",
...
eeecalshifterlayout(dqmitems, "06 L1 Trigger/04 Trigger Most Frequent Timing",
...
eeecalshifterlayout(dqmitems, "06 L1 Trigger/05 Fraction of Non Single Timing",
...
eeecalshifterlayout(dqmitems, "06 L1 Trigger/06 Timing Calo Triggers",
...
eeecalshifterlayout(dqmitems, "06 L1 Trigger/09 TTF mismatch",
...
eeecalshifterlayout(dqmitems, "06 L1 Trigger/10 Trigger Timing Occupancy EE +",
...
eeecalshifterlayout(dqmitems, "07 Selective Readout/00 Full Readout Flags",
  [{ 'path': "$prefix/EESelectiveReadoutTask/EESRT full readout SR Flags EE -", 'description': "Rate at which a readout unit is selected for a full readout (Full readout selective readout flags). It must be less than 0.05. <a href=https://twiki.cern.ch/twiki/bin/view/CMS/DQMShiftEcalExpert>DQMShiftEcalExpert</a>" }],
  [{ 'path': "$prefix/EESelectiveReadoutTask/EESRT full readout SR Flags EE +", 'description': "Rate at which a readout unit is selected for a full readout (Full readout selective readout flags). It must be less than 0.05. <a href=https://twiki.cern.ch/twiki/bin/view/CMS/DQMShiftEcalExpert>DQMShiftEcalExpert</a>" }])

eeecalshifterlayout(dqmitems, "07 Selective Readout/01 Zero Suppression Flags",
  [{ 'path': "$prefix/EESelectiveReadoutTask/EESRT zero suppression 1 SR Flags EE -", 'description': "Rate at which a readout unit is selected to have zero suppression applied on its channels. It must be larger than 0.95. <a href=https://twiki.cern.ch/twiki/bin/view/CMS/DQMShiftEcalExpert>DQMShiftEcalExpert</a>" }],
  [{ 'path': "$prefix/EESelectiveReadoutTask/EESRT zero suppression 1 SR Flags EE +", 'description': "Rate at which a readout unit is selected to have zero suppression applied on its channels. It must be larger than 0.95. <a href=https://twiki.cern.ch/twiki/bin/view/CMS/DQMShiftEcalExpert>DQMShiftEcalExpert</a>" }])

eeecalshifterlayout(dqmitems, "07 Selective Readout/02 Number of Full Readout Requests",
  [{ 'path': "$prefix/EESelectiveReadoutTask/EESRT full readout SR Flags Number EE -", 'description': "Number of barrel readout units requested to be fully-readout (Full readout selective readout flag). <a href=https://twiki.cern.ch/twiki/bin/view/CMS/DQMShiftEcalExpert>DQMShiftEcalExpert</a>" }],
  [{ 'path': "$prefix/EESelectiveReadoutTask/EESRT full readout SR Flags Number EE +", 'description': "Number of barrel readout units requested to be fully-readout (Full readout selective readout flag). <a href=https://twiki.cern.ch/twiki/bin/view/CMS/DQMShiftEcalExpert>DQMShiftEcalExpert</a>" }])

eeecalshifterlayout(dqmitems, "07 Selective Readout/03 HI Trigger Primitives Flags",
  [{ 'path': "$prefix/EESelectiveReadoutTask/EESRT high interest TT Flags EE -", 'description': "Rate of high-interest flag for each trigger tower. A high-interest flag triggers the readout of a 3x3 trigger tower region (which in the endcap is extended to a larger region made of complete readout unit). <a href=https://twiki.cern.ch/twiki/bin/view/CMS/DQMShiftEcalExpert>DQMShiftEcalExpert</a>" }],
  [{ 'path': "$prefix/EESelectiveReadoutTask/EESRT high interest TT Flags EE +", 'description': "Rate of high-interest flag for each trigger tower. A high-interest flag triggers the readout of a 3x3 trigger tower region (which in the endcap is extended to a larger region made of complete readout unit). <a href=https://twiki.cern.ch/twiki/bin/view/CMS/DQMShiftEcalExpert>DQMShiftEcalExpert</a>" }])

eeecalshifterlayout(dqmitems, "07 Selective Readout/04 MI Trigger Primitives Flags",
  [{ 'path': "$prefix/EESelectiveReadoutTask/EESRT medium interest TT Flags EE -", 'description': "Rate of mid-interest flag for each trigger tower. A mid-interest flag triggers the readout of a 1x1 trigger tower region (which in the endcap is extended to a larger region made of complete readout units). <a href=https://twiki.cern.ch/twiki/bin/view/CMS/DQMShiftEcalExpert>DQMShiftEcalExpert</a>" }],
  [{ 'path': "$prefix/EESelectiveReadoutTask/EESRT medium interest TT Flags EE +", 'description': "Rate of mid-interest flag for each trigger tower. A mid-interest flag triggers the readout of a 1x1 trigger tower region (which in the endcap is extended to a larger region made of complete readout units). <a href=https://twiki.cern.ch/twiki/bin/view/CMS/DQMShiftEcalExpert>DQMShiftEcalExpert</a>" }])

eeecalshifterlayout(dqmitems, "07 Selective Readout/05 LI Trigger Primitives Flags",
  [{ 'path': "$prefix/EESelectiveReadoutTask/EESRT low interest TT Flags EE -", 'description': "Rate of low-interest flag for each trigger tower. <a href=https://twiki.cern.ch/twiki/bin/view/CMS/DQMShiftEcalExpert>DQMShiftEcalExpert</a>" }],
  [{ 'path': "$prefix/EESelectiveReadoutTask/EESRT low interest TT Flags EE +", 'description': "Rate of low-interest flag for each trigger tower. <a href=https://twiki.cern.ch/twiki/bin/view/CMS/DQMShiftEcalExpert>DQMShiftEcalExpert</a>" }])

eeecalshifterlayout(dqmitems, "07 Selective Readout/06 Trigger Primitives Flag Forced Bit",
  [{ 'path': "$prefix/EESelectiveReadoutTask/EESRT readout unit with SR forced EE -", 'description': "Rate at which a trigger tower flag was forced either by configuration or following to an error. In current online configuration, the flag is forced to low interest. <a href=https://twiki.cern.ch/twiki/bin/view/CMS/DQMShiftEcalExpert>DQMShiftEcalExpert</a>" }],
  [{ 'path': "$prefix/EESelectiveReadoutTask/EESRT readout unit with SR forced EE +", 'description': "Rate at which a trigger tower flag was forced either by configuration or following to an error. In current online configuration, the flag is forced to low interest. <a href=https://twiki.cern.ch/twiki/bin/view/CMS/DQMShiftEcalExpert>DQMShiftEcalExpert</a>" }])

eeecalshifterlayout(dqmitems, "07 Selective Readout/07 Trigger Primitives ET map",
  [{ 'path': "$prefix/EESummaryClient/EETTT EE - Et trigger tower summary", 'description': "Averaged trigger primitive value (transverse energy) for each trigger tower. <a href=https://twiki.cern.ch/twiki/bin/view/CMS/DQMShiftEcalExpert>DQMShiftEcalExpert</a>" }],
  [{ 'path': "$prefix/EESummaryClient/EETTT EE + Et trigger tower summary", 'description': "Averaged trigger primitive value (transverse energy) for each trigger tower. <a href=https://twiki.cern.ch/twiki/bin/view/CMS/DQMShiftEcalExpert>DQMShiftEcalExpert</a>" }])
...
eeecalshifterlayout(dqmitems, "07 Selective Readout/09 Trigger Primitive Flags",
  [{ 'path': "$prefix/EESelectiveReadoutTask/EESRT TT Flags EE -", 'description': "Distribution of trigger tower flag (TTF) values. 0: low interest; 1: mid interest; 2: forbidden; 3: high interest. 4 is added to the flag value if flag was forced by configuration or because of an error. With current configuration: There should be no flags 5, 6 or 7; Tower is flagged mid-interest between 1 and 2 GeV; Flag is flagged high-interest above 2 GeV. <a href=https://twiki.cern.ch/twiki/bin/view/CMS/DQMShiftEcalExpert>DQMShiftEcalExpert</a>" }],
  [{ 'path': "$prefix/EESelectiveReadoutTask/EESRT TT Flags EE +", 'description': "Distribution of trigger tower flag (TTF) values. 0: low interest; 1: mid interest; 2: forbidden; 3: high interest. 4 is added to the flag value if flag was forced by configuration or because of an error. With current configuration: There should be no flags 5, 6 or 7; Tower is flagged mid-interest between 1 and 2 GeV; Flag is flagged high-interest above 2 GeV. <a href=https://twiki.cern.ch/twiki/bin/view/CMS/DQMShiftEcalExpert>DQMShiftEcalExpert</a>" }])

eeecalshifterlayout(dqmitems, "07 Selective Readout/10 ZS1-Flagged Fully Readout Units Map",
  [{ 'path': "$prefix/EESelectiveReadoutTask/EESRT ZS Flagged Fully Readout EE -", 'description': "Rate at which a readout unit saw all is channels read out while a zero-suppression was requested. This rate must be negligle when selective readout decision is correctly applied. <a href=https://twiki.cern.ch/twiki/bin/view/CMS/DQMShiftEcalExpert>DQMShiftEcalExpert</a>" }],
  [{ 'path': "$prefix/EESelectiveReadoutTask/EESRT ZS Flagged Fully Readout EE +", 'description': "Rate at which a readout unit saw all is channels read out while a zero-suppression was requested. This rate must be negligle when selective readout decision is correctly applied. <a href=https://twiki.cern.ch/twiki/bin/view/CMS/DQMShiftEcalExpert>DQMShiftEcalExpert</a>" }])

eeecalshifterlayout(dqmitems, "07 Selective Readout/11 ZS1-Flagged Fully Readout Units",
  [{ 'path': "$prefix/EESelectiveReadoutTask/EESRT ZS Flagged Fully Readout Number EE -", 'description': "Number of readout unit whose every channel was read out while a zero-suppression was requested. A non-zero value is very improbable when selective readout decision is correctly applied. <a href=https://twiki.cern.ch/twiki/bin/view/CMS/DQMShiftEcalExpert>DQMShiftEcalExpert</a>" }],
  [{ 'path': "$prefix/EESelectiveReadoutTask/EESRT ZS Flagged Fully Readout Number EE +", 'description': "Number of readout unit whose every channel was read out while a zero-suppression was requested. A non-zero value is very improbable when selective readout decision is correctly applied. <a href=https://twiki.cern.ch/twiki/bin/view/CMS/DQMShiftEcalExpert>DQMShiftEcalExpert</a>" }])

eeecalshifterlayout(dqmitems, "07 Selective Readout/12 Fully-Readout Dropped Units Map",
  [{ 'path': "$prefix/EESelectiveReadoutTask/EESRT FR Flagged Dropped Readout EE -", 'description': "Rate at which a readout unit had none of its channel read out, while a full readout was requested. Only masked tower are expected to have a non-null rate, in occurence a 100% rate. <a href=https://twiki.cern.ch/twiki/bin/view/CMS/DQMShiftEcalExpert>DQMShiftEcalExpert</a>" }],
  [{ 'path': "$prefix/EESelectiveReadoutTask/EESRT FR Flagged Dropped Readout EE +", 'description': "Rate at which a readout unit had none of its channel read out, while a full readout was requested. Only masked tower are expected to have a non-null rate, in occurence a 100% rate. <a href=https://twiki.cern.ch/twiki/bin/view/CMS/DQMShiftEcalExpert>DQMShiftEcalExpert</a>" }])

eeecalshifterlayout(dqmitems, "07 Selective Readout/13 Fully-Readout Dropped Units",
  [{ 'path': "$prefix/EESelectiveReadoutTask/EESRT FR Flagged Dropped Readout Number EE -", 'description': "Number of readout units whose none of the channels was read out, while a full readout was requested. <a href=https://twiki.cern.ch/twiki/bin/view/CMS/DQMShiftEcalExpert>DQMShiftEcalExpert</a>" }],
  [{ 'path': "$prefix/EESelectiveReadoutTask/EESRT FR Flagged Dropped Readout Number EE +", 'description': "Number of readout units whose none of the channels was read out, while a full readout was requested. <a href=https://twiki.cern.ch/twiki/bin/view/CMS/DQMShiftEcalExpert>DQMShiftEcalExpert</a>" }])

eeecalshifterlayout(dqmitems, "07 Selective Readout/14 Endcap Payload",
  [{ 'path': "$prefix/EESelectiveReadoutTask/EESRT event size EE -", 'description': "Size of data from barrel within the ECAL event. The averaged event size must be below 100kB. <a href=https://twiki.cern.ch/twiki/bin/view/CMS/DQMShiftEcalExpert>DQMShiftEcalExpert</a>" }],
  [{ 'path': "$prefix/EESelectiveReadoutTask/EESRT event size EE +", 'description': "Size of data from barrel within the ECAL event. The averaged event size must be below 100kB. <a href=https://twiki.cern.ch/twiki/bin/view/CMS/DQMShiftEcalExpert>DQMShiftEcalExpert</a>" }])

eeecalshifterlayout(dqmitems, "07 Selective Readout/15 HI Endcap Payload",
  [{ 'path': "$prefix/EESelectiveReadoutTask/EESRT high interest payload EE -", 'description': "Size of barrel crystal-channel data in high interest region within the ECAL event. <a href=https://twiki.cern.ch/twiki/bin/view/CMS/DQMShiftEcalExpert>DQMShiftEcalExpert</a>" }],
  [{ 'path': "$prefix/EESelectiveReadoutTask/EESRT high interest payload EE +", 'description': "Size of barrel crystal-channel data in high interest region within the ECAL event. <a href=https://twiki.cern.ch/twiki/bin/view/CMS/DQMShiftEcalExpert>DQMShiftEcalExpert</a>" }])

eeecalshifterlayout(dqmitems, "07 Selective Readout/16 LI Endcap Payload",
  [{ 'path': "$prefix/EESelectiveReadoutTask/EESRT low interest payload EE -", 'description': "Size of barrel crystal-channel data in low interest region within the ECAL event. <a href=https://twiki.cern.ch/twiki/bin/view/CMS/DQMShiftEcalExpert>DQMShiftEcalExpert</a>" }],
  [{ 'path': "$prefix/EESelectiveReadoutTask/EESRT low interest payload EE +", 'description': "Size of barrel crystal-channel data in low interest region within the ECAL event. <a href=https://twiki.cern.ch/twiki/bin/view/CMS/DQMShiftEcalExpert>DQMShiftEcalExpert</a>" }])

eeecalshifterlayout(dqmitems, "07 Selective Readout/17 DCC EventSize",
  [{ 'path': "$prefix/EESelectiveReadoutTask/EESRT DCC event size", 'description': "Average event size per ecah ECAL endcap DCC. ECAL event fragment size per DCC. Here size is computed from the list of channels that were read out. The size must be less or equal to 2kB. <a href=https://twiki.cern.ch/twiki/bin/view/CMS/DQMShiftEcalExpert>DQMShiftEcalExpert</a>", 'draw': { 'withref': "yes" } }],
...
eeecalshifterlayout(dqmitems, "07 Selective Readout/19 ZS Filter Output High Interest",
  [{ 'path': "$prefix/EESelectiveReadoutTask/EESRT high interest ZS filter output EE -", 'description': "Endcap - High Interest ZS emulation. Signal of channels from barrel high interest regions as reconstructed by the ZS emulator. Notes: These plots rely on the match of the ZS configuration with the online setting. Little excess in bin ADC_count = 0 is expected. It is due to the rounding done in the ZS filter. Positive values are round down, while negative values are round up. <a href=https://twiki.cern.ch/twiki/bin/view/CMS/DQMShiftEcalExpert>DQMShiftEcalExpert</a>", 'draw': { 'withref': "yes" } }],
  [{ 'path': "$prefix/EESelectiveReadoutTask/EESRT high interest ZS filter output EE +", 'description': "Endcap + High Interest ZS emulation. Signal of channels from barrel high interest regions as reconstructed by the ZS emulator. Notes: These plots rely on the match of the ZS configuration with the online setting. Little excess in bin ADC_count = 0 is expected. It is due to the rounding done in the ZS filter. Positive values are round down, while negative values are round up. <a href=https://twiki.cern.ch/twiki/bin/view/CMS/DQMShiftEcalExpert>DQMShiftEcalExpert</a>", 'draw': { 'withref': "yes" } }])

eeecalshifterlayout(dqmitems, "07 Selective Readout/20 ZS Filter Output Low Interest",
  [{ 'path': "$prefix/EESelectiveReadoutTask/EESRT low interest ZS filter output EE -", 'description': "Endcap - Low Interest ZS emulation. Signal of channels from barrel low interest regions as reconstructed by the ZS emulator. A sharp cut at zero suppression threshold is expected, with all bins below this threshold empty. <a href=https://twiki.cern.ch/twiki/bin/view/CMS/DQMShiftEcalExpert>DQMShiftEcalExpert</a>", 'draw': { 'withref': "yes" } }],
  [{ 'path': "$prefix/EESelectiveReadoutTask/EESRT low interest ZS filter output EE +", 'description': "Endcap + Low Interest ZS emulation. Signal of channels from barrel low interest regions as reconstructed by the ZS emulator. A sharp cut at zero suppression threshold is expected, with all bins below this threshold empty. <a href=https://twiki.cern.ch/twiki/bin/view/CMS/DQMShiftEcalExpert>DQMShiftEcalExpert</a>", 'draw': { 'withref': "yes" } }])
...
eeecalshifterlayout(dqmitems, "08 Calibration/00 Laser/00 $color Laser (L$laser) Quality",
...
eeecalshifterlayout(dqmitems, "08 Calibration/00 Laser/01 $color Laser (L$laser) Errors",
  [{ 'path': "$prefix/EESummaryClient/EELT laser quality errors summary L$laser", 'description': "Errors occupancy for $color laser events for every sector. Expect 0 entries if no errors or no laser events in a given sector. <a href=https://twiki.cern.ch/twiki/bin/view/CMS/DQMShiftEcalExpert>DQMShiftEcalExpert</a>" }])

eeecalshifterlayout(dqmitems, "08 Calibration/00 Laser/02 $color Laser (L$laser) Amplitude",
  [{ 'path': "$prefix/EESummaryClient/EELT laser L$laser amplitude summary", 'description': "Laser $color laser average amplitude for fired light modules in EE. <a href=https://twiki.cern.ch/twiki/bin/view/CMS/DQMShiftEcalExpert>DQMShiftEcalExpert</a>" }],
  [{ 'path': "$prefix/EESummaryClient/EELT laser L$laser amplitude over PN summary", 'description': "$color laser average VPT/PN ratio for fired light modules in EE. <a href=https://twiki.cern.ch/twiki/bin/view/CMS/DQMShiftEcalExpert>DQMShiftEcalExpert</a>" }])

eeecalshifterlayout(dqmitems, "08 Calibration/00 Laser/03 $color Laser (L$laser) Timing",
  [{ 'path': "$prefix/EESummaryClient/EELT laser L$laser timing summary", 'description': "$color laser average timing (in pulse shape samples) for fired light modules in EE. Expect value around 6.5. <a href=https://twiki.cern.ch/twiki/bin/view/CMS/DQMShiftEcalExpert>DQMShiftEcalExpert</a>" }],
  [None])

eeecalshifterlayout(dqmitems, "08 Calibration/00 Laser/04 $color Laser (L$laser) PNQuality",
...
eeecalshifterlayout(dqmitems, "08 Calibration/01 Led/00 L$led Quality", 
...
eeecalshifterlayout(dqmitems, "08 Calibration/01 Led/01 L$led Errors",
...
eeecalshifterlayout(dqmitems, "08 Calibration/01 Led/02 L$led Amplitude",
...
eeecalshifterlayout(dqmitems, "08 Calibration/01 Led/03 L$led Timing",
...
eeecalshifterlayout(dqmitems, "08 Calibration/01 Led/04 L$led PNQuality",
...
eeecalshifterlayout(dqmitems, "08 Calibration/02 Pedestal/00 Quality Gain$gain",
...
eeecalshifterlayout(dqmitems, "08 Calibration/02 Pedestal/01 PNQuality Gain$gainPN",
...
eeecalshifterlayout(dqmitems, "08 Calibration/03 TestPulse/00 Quality Gain$gain",
...
eeecalshifterlayout(dqmitems, "08 Calibration/03 TestPulse/01 Amplitude Gain$gain",
...
eeecalshifterlayout(dqmitems, "08 Calibration/03 TestPulse/05 PNQuality Gain$gainPN",
...
eeecalshifterlayout(dqmitems, "09 Trend/00 Crystal Digis Number",
...
eeecalshifterlayout(dqmitems, "09 Trend/01 PN Diodes Digis Number",
  [{ 'path': "$prefix/EETrendTask/AverageNumberOfEcalPnDiodeDigiVs5Minutes", 'description': "Average number of endcap PN diodes digis (5 minutes range). <a href=https://twiki.cern.ch/twiki/bin/view/CMS/DQMShiftEcalExpert>DQMShiftEcalExpert</a>" }],
  [{ 'path': "$prefix/EETrendTask/AverageNumberOfEcalPnDiodeDigiVs1Hour", 'description': "Average number of endcap PN diodes digis (1 hour range). <a href=https://twiki.cern.ch/twiki/bin/view/CMS/DQMShiftEcalExpert>DQMShiftEcalExpert</a>" }])
   
eeecalshifterlayout(dqmitems, "09 Trend/02 Hit with Threshold Occupancy EE -",
  [{ 'path': "$prefix/EETrendClient/Average of EEOT rec hit thr occupancy EE - Vs 5Minutes", 'description': "Average occupancy for endcap reconstructed hits with energy > 1 GeV and good quality, i.e. noisy channels removed. (5 minutes range). <a href=https://twiki.cern.ch/twiki/bin/view/CMS/DQMShiftEcalExpert>DQMShiftEcalExpert</a>" }],
  [{ 'path': "$prefix/EETrendClient/Average of EEOT rec hit thr occupancy EE - Vs 1Hour", 'description': "Average occupancy for endcap reconstructed hits with energy > 1 GeV and good quality, i.e. noisy channels removed. (1 hour range). <a href=https://twiki.cern.ch/twiki/bin/view/CMS/DQMShiftEcalExpert>DQMShiftEcalExpert</a>" }])

eeecalshifterlayout(dqmitems, "09 Trend/02 Hit with Threshold Occupancy EE +",
  [{ 'path': "$prefix/EETrendClient/Average of EEOT rec hit thr occupancy EE + Vs 5Minutes", 'description': "Average occupancy for endcap reconstructed hits with energy > 1 GeV and good quality, i.e. noisy channels removed. (5 minutes range). <a href=https://twiki.cern.ch/twiki/bin/view/CMS/DQMShiftEcalExpert>DQMShiftEcalExpert</a>" }],
  [{ 'path': "$prefix/EETrendClient/Average of EEOT rec hit thr occupancy EE + Vs 1Hour", 'description': "Average occupancy for endcap reconstructed hits with energy > 1 GeV and good quality, i.e. noisy channels removed. (1 hour range). <a href=https://twiki.cern.ch/twiki/bin/view/CMS/DQMShiftEcalExpert>DQMShiftEcalExpert</a>" }])

eeecalshifterlayout(dqmitems, "09 Trend/03 TP Digis Occupancy EE -",
  [{ 'path': "$prefix/EETrendClient/Average of EEOT TP digi thr occupancy EE - Vs 5Minutes", 'description': "Average occupancy of TP digis with ET >~ 1 GeV. (5 minutes range). <a href=https://twiki.cern.ch/twiki/bin/view/CMS/DQMShiftEcalExpert>DQMShiftEcalExpert</a>" }],
  [{ 'path': "$prefix/EETrendClient/Average of EEOT TP digi thr occupancy EE - Vs 1Hour", 'description': "Average occupancy of TP digis with ET >~ 1 GeV. (1 hour range). <a href=https://twiki.cern.ch/twiki/bin/view/CMS/DQMShiftEcalExpert>DQMShiftEcalExpert</a>" }])

eeecalshifterlayout(dqmitems, "09 Trend/03 TP Digis Occupancy EE +",
  [{ 'path': "$prefix/EETrendClient/Average of EEOT TP digi thr occupancy EE + Vs 5Minutes", 'description': "Average occupancy of TP digis with ET >~ 1 GeV. (5 minutes range). <a href=https://twiki.cern.ch/twiki/bin/view/CMS/DQMShiftEcalExpert>DQMShiftEcalExpert</a>" }],
  [{ 'path': "$prefix/EETrendClient/Average of EEOT TP digi thr occupancy EE + Vs 1Hour", 'description': "Average occupancy of TP digis with ET >~ 1 GeV. (1 hour range). <a href=https://twiki.cern.ch/twiki/bin/view/CMS/DQMShiftEcalExpert>DQMShiftEcalExpert</a>" }])

eeecalshifterlayout(dqmitems, "09 Trend/04 Basic Clusters Number",
  [{ 'path': "$prefix/EETrendTask/AverageNumberOfBasicClusterSizeVs5Minutes", 'description': "Average number of basic clusters (5 minutes range). <a href=https://twiki.cern.ch/twiki/bin/view/CMS/DQMShiftEcalExpert>DQMShiftEcalExpert</a>" }],
  [{ 'path': "$prefix/EETrendTask/AverageNumberOfBasicClusterSizeVs1Hour", 'description': "Average number of basic clusters (1 hour range). <a href=https://twiki.cern.ch/twiki/bin/view/CMS/DQMShiftEcalExpert>DQMShiftEcalExpert</a>" }])

eeecalshifterlayout(dqmitems, "09 Trend/05 Basic Cluster Energy",
  [{ 'path': "$prefix/EETrendClient/Average of EECLT BC energy Vs 5Minutes", 'description': "Average energy of reconstructed endcap basic clusters. (5 minutes range). <a href=https://twiki.cern.ch/twiki/bin/view/CMS/DQMShiftEcalExpert>DQMShiftEcalExpert</a>" }],
  [{ 'path': "$prefix/EETrendClient/Average of EECLT BC energy Vs 1Hour", 'description': "Average energy of reconstructed endcap basic clusters. (1 hour range). <a href=https://twiki.cern.ch/twiki/bin/view/CMS/DQMShiftEcalExpert>DQMShiftEcalExpert</a>" }])

eeecalshifterlayout(dqmitems, "09 Trend/06 Super Clusters Number",
  [{ 'path': "$prefix/EETrendTask/AverageNumberOfSuperClusterSizeVs5Minutes", 'description': "Average number of super clusters (5 minutes range). <a href=https://twiki.cern.ch/twiki/bin/view/CMS/DQMShiftEcalExpert>DQMShiftEcalExpert</a>" }],
  [{ 'path': "$prefix/EETrendTask/AverageNumberOfSuperClusterSizeVs1Hour", 'description': "Average number of super clusters (1 hour range). <a href=https://twiki.cern.ch/twiki/bin/view/CMS/DQMShiftEcalExpert>DQMShiftEcalExpert</a>" }])

eeecalshifterlayout(dqmitems, "09 Trend/07 Super Cluster Energy",
  [{ 'path': "$prefix/EETrendClient/Average of EECLT SC energy Vs 5Minutes", 'description': "Average energy of reconstructed endcap basic clusters. (5 minutes range). <a href=https://twiki.cern.ch/twiki/bin/view/CMS/DQMShiftEcalExpert>DQMShiftEcalExpert</a>" }],
  [{ 'path': "$prefix/EETrendClient/Average of EECLT SC energy Vs 1Hour", 'description': "Average energy of reconstructed endcap basic clusters. (1 hour range). <a href=https://twiki.cern.ch/twiki/bin/view/CMS/DQMShiftEcalExpert>DQMShiftEcalExpert</a>" }])

eeecalshifterlayout(dqmitems, "09 Trend/08 Pedestal Mean",
  [{ 'path': "$prefix/EETrendClient/Average of EEPOT pedestal G12 mean Vs 5Minutes", 'description': "Average pedestal mean in endcap crystals (5 minutes range). <a href=https://twiki.cern.ch/twiki/bin/view/CMS/DQMShiftEcalExpert>DQMShiftEcalExpert</a>" }],
  [{ 'path': "$prefix/EETrendClient/Average of EEPOT pedestal G12 mean Vs 1Hour", 'description': "Average pedestal mean in endcap crystals (1 hour range). <a href=https://twiki.cern.ch/twiki/bin/view/CMS/DQMShiftEcalExpert>DQMShiftEcalExpert</a>" }])

eeecalshifterlayout(dqmitems, "09 Trend/09 Pedestal RMS",
  [{ 'path': "$prefix/EETrendClient/Average of EEPOT pedestal G12 rms Vs 5Minutes", 'description': "Average pedestal rms in endcap crystals (5 minutes range). <a href=https://twiki.cern.ch/twiki/bin/view/CMS/DQMShiftEcalExpert>DQMShiftEcalExpert</a>" }],
  [{ 'path': "$prefix/EETrendClient/Average of EEPOT pedestal G12 rms Vs 1Hour", 'description': "Average pedestal rms in endcap crystals (1 hour range). <a href=https://twiki.cern.ch/twiki/bin/view/CMS/DQMShiftEcalExpert>DQMShiftEcalExpert</a>" }])

eeecalshifterlayout(dqmitems, "09 Trend/10 Integrity Errors Number",
  [{ 'path': "$prefix/EETrendTask/AverageNumberOfIntegrityErrorVs5Minutes", 'description': "Average number of integrity errors (5 minutes range). <a href=https://twiki.cern.ch/twiki/bin/view/CMS/DQMShiftEcalExpert>DQMShiftEcalExpert</a>" }],
  [{ 'path': "$prefix/EETrendTask/AverageNumberOfIntegrityErrorVs1Hour", 'description': "Average number of integrity errors (1 hour range). <a href=https://twiki.cern.ch/twiki/bin/view/CMS/DQMShiftEcalExpert>DQMShiftEcalExpert</a>" }])

eeecalshifterlayout(dqmitems, "09 Trend/11 EE - FEDs Size ",
...
eeecalshifterlayout(dqmitems, "09 Trend/12 Selective Readout Flags Size ",
  [{ 'path': "$prefix/EETrendTask/AverageNumberOfEESRFlagVs5Minutes", 'description': "Average number of Selective Readout Flags. (5 minutes range). <a href=https://twiki.cern.ch/twiki/bin/view/CMS/DQMShiftEcalExpert>DQMShiftEcalExpert</a>" }],
  [{ 'path': "$prefix/EETrendTask/AverageNumberOfEESRFlagVs1Hour", 'description': "Average number of Selective Readout Flags. (1 hour range). <a href=https://twiki.cern.ch/twiki/bin/view/CMS/DQMShiftEcalExpert>DQMShiftEcalExpert</a>" }])
...
eelayout(dqmitems, "01 By Supermodule/$ee1/06 Energy",
  [{ 'path': "$prefix/EEOccupancyTask/EEOT rec hit energy $ee2", 'description': "Average energy of the rechits selected among good (rechit quality flag and channel status) reconstructed hits. <a href=https://twiki.cern.ch/twiki/bin/view/CMS/DQMShiftEcalExpert>DQMShiftEcalExpert</a>" }],
  [{ 'path': "$prefix/EEOccupancyTask/EEOT energy spectrum $ee2", 'description': "Calibrated energy spectrum of the good reconstructed hits (rechit quality flag and channel status). <a href=https://twiki.cern.ch/twiki/bin/view/CMS/DQMShiftEcalExpert>DQMShiftEcalExpert</a>", 'draw': { 'withref': "yes" } }])
...
eelayout(dqmitems, "01 By Supermodule/$ee1/Experts/06 Cosmic/Rechits Energy",
  [{ 'path': "$prefix/EEOccupancyTask/EEOT rec hit energy $ee2", 'description': "Average energy of the rechits selected among good (rechit quality flag and channel status) reconstructed rechits. <a href=https://twiki.cern.ch/twiki/bin/view/CMS/DQMShiftEcalExpert>DQMShiftEcalExpert</a>" }])

eelayout(dqmitems, "01 By Supermodule/$ee1/Experts/06 Cosmic/Rechits Energy Spectrum",
  [{ 'path': "$prefix/EEOccupancyTask/EEOT energy spectrum $ee2", 'description': "Calibrated energy spectrum of the good reconstructed hits (rechit quality flag and channel status). <a href=https://twiki.cern.ch/twiki/bin/view/CMS/DQMShiftEcalExpert>DQMShiftEcalExpert</a>", 'draw': { 'withref': "yes" } }])
EOF02
...
eelayout(dqmitems, "00 By Task/00 Summary/03 Energy Summary",
  [{ 'path': "$prefix/EESummaryClient/EEOT EE - energy summary", 'description': "<a href=https://twiki.cern.ch/twiki/bin/view/CMS/DQMShiftEcalExpert>DQMShiftEcalExpert</a>" }],
  [{ 'path': "$prefix/EESummaryClient/EEOT EE + energy summary", 'description': "<a href=https://twiki.cern.ch/twiki/bin/view/CMS/DQMShiftEcalExpert>DQMShiftEcalExpert</a>" }])
...
eelayout(dqmitems, "00 By Task/09 Energy/00 Energy Summary",
  [{ 'path': "$prefix/EESummaryClient/EEOT EE - energy summary", 'description': "Average energy (in GeV) of the rechits selected among good (rechit quality flag and channel status) reconstructed hits. Physics events only. <a href=https://twiki.cern.ch/twiki/bin/view/CMS/DQMShiftEcalExpert>DQMShiftEcalExpert</a>" }])

eelayout(dqmitems, "00 By Task/09 Energy/01 Energy Summary",
  [{ 'path': "$prefix/EESummaryClient/EEOT EE + energy summary", 'description': "Average energy (in GeV) of the rechits selected among good (rechit quality flag and channel status) reconstructed hits. Physics events only. <a href=https://twiki.cern.ch/twiki/bin/view/CMS/DQMShiftEcalExpert>DQMShiftEcalExpert</a>" }])

eelayout(dqmitems, "00 By Task/09 Energy/$ee1/00 Energy",
  [{ 'path': "$prefix/EEOccupancyTask/EEOT rec hit energy $ee2", 'description': "Average energy of the rechits selected among good (rechit quality flag and channel status) reconstructed hits. <a href=https://twiki.cern.ch/twiki/bin/view/CMS/DQMShiftEcalExpert>DQMShiftEcalExpert</a>" }])

eelayout(dqmitems, "00 By Task/09 Energy/$ee1/01 Energy",
  [{ 'path': "$prefix/EEOccupancyTask/EEOT energy spectrum $ee2", 'description': "Calibrated energy spectrum of the good reconstructed hits (rechit quality flag and channel status). <a href=https://twiki.cern.ch/twiki/bin/view/CMS/DQMShiftEcalExpert>DQMShiftEcalExpert</a>", 'draw': { 'withref': "yes" } }])
...
eelayout(dqmitems, "00 By Task/14 SelectiveReadout/00 Full Readout Flags",
  [{ 'path': "$prefix/EESelectiveReadoutTask/EESRT full readout SR Flags EE -", 'description': "Rate at which a readout unit is selected for a full readout (Full readout selective readout flags). It must be less than 0.05. <a href=https://twiki.cern.ch/twiki/bin/view/CMS/DQMShiftEcalExpert>DQMShiftEcalExpert</a>" }],
  [{ 'path': "$prefix/EESelectiveReadoutTask/EESRT full readout SR Flags EE +", 'description': "Rate at which a readout unit is selected for a full readout (Full readout selective readout flags). It must be less than 0.05. <a href=https://twiki.cern.ch/twiki/bin/view/CMS/DQMShiftEcalExpert>DQMShiftEcalExpert</a>" }])

eelayout(dqmitems, "00 By Task/14 SelectiveReadout/01 Zero Suppression Flags",
  [{ 'path': "$prefix/EESelectiveReadoutTask/EESRT zero suppression 1 SR Flags EE -", 'description': "Rate at which a readout unit is selected to have zero suppression applied on its channels. It must be larger than 0.95. <a href=https://twiki.cern.ch/twiki/bin/view/CMS/DQMShiftEcalExpert>DQMShiftEcalExpert</a>" }],
  [{ 'path': "$prefix/EESelectiveReadoutTask/EESRT zero suppression 1 SR Flags EE +", 'description': "Rate at which a readout unit is selected to have zero suppression applied on its channels. It must be larger than 0.95. <a href=https://twiki.cern.ch/twiki/bin/view/CMS/DQMShiftEcalExpert>DQMShiftEcalExpert</a>" }])

eelayout(dqmitems, "00 By Task/14 SelectiveReadout/02 Number of Full Readout Requests",
  [{ 'path': "$prefix/EESelectiveReadoutTask/EESRT full readout SR Flags Number EE -", 'description': "Number of barrel readout units requested to be fully-readout (Full readout selective readout flag). <a href=https://twiki.cern.ch/twiki/bin/view/CMS/DQMShiftEcalExpert>DQMShiftEcalExpert</a>" }],
  [{ 'path': "$prefix/EESelectiveReadoutTask/EESRT full readout SR Flags Number EE +", 'description': "Number of barrel readout units requested to be fully-readout (Full readout selective readout flag). <a href=https://twiki.cern.ch/twiki/bin/view/CMS/DQMShiftEcalExpert>DQMShiftEcalExpert</a>" }])

eelayout(dqmitems, "00 By Task/14 SelectiveReadout/03 HI Trigger Primitives Flags",
  [{ 'path': "$prefix/EESelectiveReadoutTask/EESRT high interest TT Flags EE -", 'description': "Rate of high-interest flag for each trigger tower. A high-interest flag triggers the readout of a 3x3 trigger tower region (which in the endcap is extended to a larger region made of complete readout unit). <a href=https://twiki.cern.ch/twiki/bin/view/CMS/DQMShiftEcalExpert>DQMShiftEcalExpert</a>" }],
  [{ 'path': "$prefix/EESelectiveReadoutTask/EESRT high interest TT Flags EE +", 'description': "Rate of high-interest flag for each trigger tower. A high-interest flag triggers the readout of a 3x3 trigger tower region (which in the endcap is extended to a larger region made of complete readout unit). <a href=https://twiki.cern.ch/twiki/bin/view/CMS/DQMShiftEcalExpert>DQMShiftEcalExpert</a>" }])

eelayout(dqmitems, "00 By Task/14 SelectiveReadout/04 MI Trigger Primitives Flags",
  [{ 'path': "$prefix/EESelectiveReadoutTask/EESRT medium interest TT Flags EE -", 'description': "Rate of mid-interest flag for each trigger tower. A mid-interest flag triggers the readout of a 1x1 trigger tower region (which in the endcap is extended to a larger region made of complete readout units). <a href=https://twiki.cern.ch/twiki/bin/view/CMS/DQMShiftEcalExpert>DQMShiftEcalExpert</a>" }],
  [{ 'path': "$prefix/EESelectiveReadoutTask/EESRT medium interest TT Flags EE +", 'description': "Rate of mid-interest flag for each trigger tower. A mid-interest flag triggers the readout of a 1x1 trigger tower region (which in the endcap is extended to a larger region made of complete readout units). <a href=https://twiki.cern.ch/twiki/bin/view/CMS/DQMShiftEcalExpert>DQMShiftEcalExpert</a>" }])

eelayout(dqmitems, "00 By Task/14 SelectiveReadout/05 LI Trigger Primitives Flags",
  [{ 'path': "$prefix/EESelectiveReadoutTask/EESRT low interest TT Flags EE -", 'description': "Rate of low-interest flag for each trigger tower. <a href=https://twiki.cern.ch/twiki/bin/view/CMS/DQMShiftEcalExpert>DQMShiftEcalExpert</a>" }],
  [{ 'path': "$prefix/EESelectiveReadoutTask/EESRT low interest TT Flags EE +", 'description': "Rate of low-interest flag for each trigger tower. <a href=https://twiki.cern.ch/twiki/bin/view/CMS/DQMShiftEcalExpert>DQMShiftEcalExpert</a>" }])

eelayout(dqmitems, "00 By Task/14 SelectiveReadout/06 Trigger Primitives Flag Forced Bit",
  [{ 'path': "$prefix/EESelectiveReadoutTask/EESRT readout unit with SR forced EE -", 'description': "Rate at which a trigger tower flag was forced either by configuration or following to an error. In current online configuration, the flag is forced to low interest. <a href=https://twiki.cern.ch/twiki/bin/view/CMS/DQMShiftEcalExpert>DQMShiftEcalExpert</a>" }],
  [{ 'path': "$prefix/EESelectiveReadoutTask/EESRT readout unit with SR forced EE +", 'description': "Rate at which a trigger tower flag was forced either by configuration or following to an error. In current online configuration, the flag is forced to low interest. <a href=https://twiki.cern.ch/twiki/bin/view/CMS/DQMShiftEcalExpert>DQMShiftEcalExpert</a>" }])

eelayout(dqmitems, "00 By Task/14 SelectiveReadout/07 Trigger Primitives ET map",
  [{ 'path': "$prefix/EESummaryClient/EETTT EE - Et trigger tower summary", 'description': "Averaged trigger primitive value (transverse energy) for each trigger tower. <a href=https://twiki.cern.ch/twiki/bin/view/CMS/DQMShiftEcalExpert>DQMShiftEcalExpert</a>" }],
  [{ 'path': "$prefix/EESummaryClient/EETTT EE + Et trigger tower summary", 'description': "Averaged trigger primitive value (transverse energy) for each trigger tower. <a href=https://twiki.cern.ch/twiki/bin/view/CMS/DQMShiftEcalExpert>DQMShiftEcalExpert</a>" }])

eelayout(dqmitems, "00 By Task/14 SelectiveReadout/08 Trigger Primitives ET",
  [{ 'path': "$prefix/EETriggerTowerTask/EETTT Et spectrum Real Digis EE -", 'description': "Average transverse energy (4 ADC count = 1 GeV) of real L1 trigger primitives. <a href=https://twiki.cern.ch/twiki/bin/view/CMS/DQMShiftEcalExpert>DQMShiftEcalExpert</a>", 'draw': { 'withref': "yes" } }],
  [{ 'path': "$prefix/EETriggerTowerTask/EETTT Et spectrum Real Digis EE +", 'description': "Average transverse energy (4 ADC count = 1 GeV) of real L1 trigger primitives. <a href=https://twiki.cern.ch/twiki/bin/view/CMS/DQMShiftEcalExpert>DQMShiftEcalExpert</a>", 'draw': { 'withref': "yes" } }])

eelayout(dqmitems, "00 By Task/14 SelectiveReadout/09 Trigger Primitive Flags",
  [{ 'path': "$prefix/EESelectiveReadoutTask/EESRT TT Flags EE -", 'description': "Distribution of trigger tower flag (TTF) values. 0: low interest; 1: mid interest; 2: forbidden; 3: high interest. 4 is added to the flag value if flag was forced by configuration or because of an error. With current configuration: There should be no flags 5, 6 or 7; Tower is flagged mid-interest between 1 and 2 GeV; Flag is flagged high-interest above 2 GeV. <a href=https://twiki.cern.ch/twiki/bin/view/CMS/DQMShiftEcalExpert>DQMShiftEcalExpert</a>" }],
  [{ 'path': "$prefix/EESelectiveReadoutTask/EESRT TT Flags EE +", 'description': "Distribution of trigger tower flag (TTF) values. 0: low interest; 1: mid interest; 2: forbidden; 3: high interest. 4 is added to the flag value if flag was forced by configuration or because of an error. With current configuration: There should be no flags 5, 6 or 7; Tower is flagged mid-interest between 1 and 2 GeV; Flag is flagged high-interest above 2 GeV. <a href=https://twiki.cern.ch/twiki/bin/view/CMS/DQMShiftEcalExpert>DQMShiftEcalExpert</a>" }])

eelayout(dqmitems, "00 By Task/14 SelectiveReadout/10 ZS1-Flagged Fully Readout Units Map",
  [{ 'path': "$prefix/EESelectiveReadoutTask/EESRT ZS Flagged Fully Readout EE -", 'description': "Rate at which a readout unit saw all is channels read out while a zero-suppression was requested. This rate must be negligle when selective readout decision is correctly applied. <a href=https://twiki.cern.ch/twiki/bin/view/CMS/DQMShiftEcalExpert>DQMShiftEcalExpert</a>" }],
  [{ 'path': "$prefix/EESelectiveReadoutTask/EESRT ZS Flagged Fully Readout EE +", 'description': "Rate at which a readout unit saw all is channels read out while a zero-suppression was requested. This rate must be negligle when selective readout decision is correctly applied. <a href=https://twiki.cern.ch/twiki/bin/view/CMS/DQMShiftEcalExpert>DQMShiftEcalExpert</a>" }])

eelayout(dqmitems, "00 By Task/14 SelectiveReadout/11 ZS1-Flagged Fully Readout Units",
  [{ 'path': "$prefix/EESelectiveReadoutTask/EESRT ZS Flagged Fully Readout Number EE -", 'description': "Number of readout unit whose every channel was read out while a zero-suppression was requested. A non-zero value is very improbable when selective readout decision is correctly applied. <a href=https://twiki.cern.ch/twiki/bin/view/CMS/DQMShiftEcalExpert>DQMShiftEcalExpert</a>" }],
  [{ 'path': "$prefix/EESelectiveReadoutTask/EESRT ZS Flagged Fully Readout Number EE +", 'description': "Number of readout unit whose every channel was read out while a zero-suppression was requested. A non-zero value is very improbable when selective readout decision is correctly applied. <a href=https://twiki.cern.ch/twiki/bin/view/CMS/DQMShiftEcalExpert>DQMShiftEcalExpert</a>" }])

eelayout(dqmitems, "00 By Task/14 SelectiveReadout/12 Fully-Readout Dropped Units Map",
  [{ 'path': "$prefix/EESelectiveReadoutTask/EESRT FR Flagged Dropped Readout EE -", 'description': "Rate at which a readout unit had none of its channel read out, while a full readout was requested. Only masked tower are expected to have a non-null rate, in occurence a 100% rate. <a href=https://twiki.cern.ch/twiki/bin/view/CMS/DQMShiftEcalExpert>DQMShiftEcalExpert</a>" }],
  [{ 'path': "$prefix/EESelectiveReadoutTask/EESRT FR Flagged Dropped Readout EE +", 'description': "Rate at which a readout unit had none of its channel read out, while a full readout was requested. Only masked tower are expected to have a non-null rate, in occurence a 100% rate. <a href=https://twiki.cern.ch/twiki/bin/view/CMS/DQMShiftEcalExpert>DQMShiftEcalExpert</a>" }])

eelayout(dqmitems, "00 By Task/14 SelectiveReadout/13 Fully-Readout Dropped Units",
  [{ 'path': "$prefix/EESelectiveReadoutTask/EESRT FR Flagged Dropped Readout Number EE -", 'description': "Number of readout units whose none of the channels was read out, while a full readout was requested. <a href=https://twiki.cern.ch/twiki/bin/view/CMS/DQMShiftEcalExpert>DQMShiftEcalExpert</a>" }],
  [{ 'path': "$prefix/EESelectiveReadoutTask/EESRT FR Flagged Dropped Readout Number EE +", 'description': "Number of readout units whose none of the channels was read out, while a full readout was requested. <a href=https://twiki.cern.ch/twiki/bin/view/CMS/DQMShiftEcalExpert>DQMShiftEcalExpert</a>" }])

eelayout(dqmitems, "00 By Task/14 SelectiveReadout/14 Endcap Payload",
  [{ 'path': "$prefix/EESelectiveReadoutTask/EESRT event size EE -", 'description': "Size of data from barrel within the ECAL event. The averaged event size must be below 100kB. <a href=https://twiki.cern.ch/twiki/bin/view/CMS/DQMShiftEcalExpert>DQMShiftEcalExpert</a>" }],
  [{ 'path': "$prefix/EESelectiveReadoutTask/EESRT event size EE +", 'description': "Size of data from barrel within the ECAL event. The averaged event size must be below 100kB. <a href=https://twiki.cern.ch/twiki/bin/view/CMS/DQMShiftEcalExpert>DQMShiftEcalExpert</a>" }])

eelayout(dqmitems, "00 By Task/14 SelectiveReadout/15 HI Endcap Payload",
  [{ 'path': "$prefix/EESelectiveReadoutTask/EESRT high interest payload EE -", 'description': "Size of barrel crystal-channel data in high interest region within the ECAL event. <a href=https://twiki.cern.ch/twiki/bin/view/CMS/DQMShiftEcalExpert>DQMShiftEcalExpert</a>" }],
  [{ 'path': "$prefix/EESelectiveReadoutTask/EESRT high interest payload EE +", 'description': "Size of barrel crystal-channel data in high interest region within the ECAL event. <a href=https://twiki.cern.ch/twiki/bin/view/CMS/DQMShiftEcalExpert>DQMShiftEcalExpert</a>" }])

eelayout(dqmitems, "00 By Task/14 SelectiveReadout/16 LI Endcap Payload",
  [{ 'path': "$prefix/EESelectiveReadoutTask/EESRT low interest payload EE -", 'description': "Size of barrel crystal-channel data in low interest region within the ECAL event. <a href=https://twiki.cern.ch/twiki/bin/view/CMS/DQMShiftEcalExpert>DQMShiftEcalExpert</a>" }],
  [{ 'path': "$prefix/EESelectiveReadoutTask/EESRT low interest payload EE +", 'description': "Size of barrel crystal-channel data in low interest region within the ECAL event. <a href=https://twiki.cern.ch/twiki/bin/view/CMS/DQMShiftEcalExpert>DQMShiftEcalExpert</a>" }])

eelayout(dqmitems, "00 By Task/14 SelectiveReadout/17 DCC EventSize",
  [{ 'path': "$prefix/EESelectiveReadoutTask/EESRT DCC event size", 'description': "Average event size per ecah ECAL endcap DCC. ECAL event fragment size per DCC. Here size is computed from the list of channels that were read out. The size must be less or equal to 2kB. <a href=https://twiki.cern.ch/twiki/bin/view/CMS/DQMShiftEcalExpert>DQMShiftEcalExpert</a>", 'draw': { 'withref': "yes" } }],
  [{ 'path': "$prefix/EESelectiveReadoutTask/EESRT event size vs DCC", 'description': "Event size distribution per each ECAL endcap DCC. Finer binning is used in the zero-suppressed region (0-0.608 kB), while granularity of one fully readout tower (0.608 kB) has been used for higher sizes. <a href=https://twiki.cern.ch/twiki/bin/view/CMS/DQMShiftEcalExpert>DQMShiftEcalExpert</a>"}])

eelayout(dqmitems, "00 By Task/14 SelectiveReadout/18 Tower Size",
  [{ 'path': "$prefix/EESelectiveReadoutTask/EESRT tower event size EE -", 'description': "Event size distribution per tower. This plot allows to verify the correctness of the ZS thresholds applied. The average of the plot has to be ~ 2kB / 68 ~ 30 bytes.<a href=https://twiki.cern.ch/twiki/bin/view/CMS/DQMShiftEcalExpert>DQMShiftEcalExpert</a>" }],
  [{ 'path': "$prefix/EESelectiveReadoutTask/EESRT tower event size EE +", 'description': "Event size distribution per tower. This plot allows to verify the correctness of the ZS thresholds applied. The average of the plot has to be ~ 2kB / 68 ~ 30 bytes.<a href=https://twiki.cern.ch/twiki/bin/view/CMS/DQMShiftEcalExpert>DQMShiftEcalExpert</a>" }])

eelayout(dqmitems, "00 By Task/14 SelectiveReadout/19 ZS Filter Output High Interest",
  [{ 'path': "$prefix/EESelectiveReadoutTask/EESRT high interest ZS filter output EE -", 'description': "Endcap - High Interest ZS emulation. Signal of channels from barrel high interest regions as reconstructed by the ZS emulator. Notes: These plots rely on the match of the ZS configuration with the online setting. Little excess in bin ADC_count = 0 is expected. It is due to the rounding done in the ZS filter. Positive values are round down, while negative values are round up. <a href=https://twiki.cern.ch/twiki/bin/view/CMS/DQMShiftEcalExpert>DQMShiftEcalExpert</a>", 'draw': { 'withref': "yes" } }],
  [{ 'path': "$prefix/EESelectiveReadoutTask/EESRT high interest ZS filter output EE +", 'description': "Endcap + High Interest ZS emulation. Signal of channels from barrel high interest regions as reconstructed by the ZS emulator. Notes: These plots rely on the match of the ZS configuration with the online setting. Little excess in bin ADC_count = 0 is expected. It is due to the rounding done in the ZS filter. Positive values are round down, while negative values are round up. <a href=https://twiki.cern.ch/twiki/bin/view/CMS/DQMShiftEcalExpert>DQMShiftEcalExpert</a>", 'draw': { 'withref': "yes" } }])
