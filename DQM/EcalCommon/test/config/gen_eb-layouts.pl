...
ebshifterlayout(dqmitems, "02 StatusFlags Summary",
  [{ 'path': "$prefix/EBSummaryClient/EBSFT front-end status summary", 'description': "DCC front-end status quality summary. Expected all green color. <a href=https://twiki.cern.ch/twiki/bin/view/CMS/DQMShiftEcal>DQMShiftEcal</a>" }])
...
ebshifterlayout(dqmitems, "08 LaserL1 Quality",
...
ebshifterlayout(dqmitems, "12 Selective Readout High Interest TTs",
...
ebecalshifterlayout(dqmitems, "01 Electronics/03 FrontEnd Summary",
  [{ 'path': "$prefix/EBSummaryClient/EBSFT front-end status summary", 'description': "DCC front-end status quality summary. Expected all green color. Legend: green = good;  red = bad;  yellow = no entries. <a href=https://twiki.cern.ch/twiki/bin/view/CMS/DQMShiftEcalExpert>DQMShiftEcalExpert</a>" }])
...
ebecalshifterlayout(dqmitems, "02 Noise/00 PedestalOnline Quality",
  [{ 'path': "$prefix/EBSummaryClient/EBPOT pedestal quality summary G12", 'description': "pedestal quality summary. Pedestal is evaluated using the first 3/10 samples of the pulse shape for all the events (on physics events only). Expected all green color. Legend: green = good;  red = bad;  yellow = no entries. <a href=https://twiki.cern.ch/twiki/bin/view/CMS/DQMShiftEcalExpert>DQMShiftEcalExpert</a>" }])
...
#   [{ 'path': "$prefix/EBSummaryClient/EBCT cosmic summary", 'description': "Average energy (in GeV) of hits selected with cosmics analysis. Physics events only. <a href=https://twiki.cern.ch/twiki/bin/view/CMS/DQMShiftEcalExpert>DQMShiftEcalExpert</a>" }],
  [{ 'path': "$prefix/EBOccupancyTask/EBOT rec hit spectrum", 'description': "Average energy (in GeV) of good hits. Physics events only. <a href=https://twiki.cern.ch/twiki/bin/view/CMS/DQMShiftEcalExpert>DQMShiftEcalExpert</a>" }])
...
ebecalshifterlayout(dqmitems, "04 Energy/07 SuperClusters 1D",
...
ebecalshifterlayout(dqmitems, "04 Energy/08 Peaks",
...
ebecalshifterlayout(dqmitems, "05 Timing/01 Timing Mean",
  [{ 'path': "$prefix/EBSummaryClient/EBTMT timing mean 1D summary", 'description': "Mean timing of all the channels in EB along the run. Timing is expected within 5.5 - 6.5 clocks. <a href=https://twiki.cern.ch/twiki/bin/view/CMS/DQMShiftEcalExpert>DQMShiftEcalExpert</a>", 'draw': { 'withref': "yes" } }],
...
ebecalshifterlayout(dqmitems, "05 Timing/02 Timing RMS",
  [{ 'path': "$prefix/EBSummaryClient/EBTMT timing rms 1D summary", 'description': "Average timing RMS along the run of all the channels in EB. Timing RMS is expected < 0.5 clocks. <a href=https://twiki.cern.ch/twiki/bin/view/CMS/DQMShiftEcalExpert>DQMShiftEcalExpert</a>", 'draw': { 'withref': "yes" } }],
  [{ 'path': "$prefix/EBSummaryClient/EBTMT timing rms", 'description': "Average timing RMS along the run of all the channels in each DCC of EB. The error bar represents the spreads among the crystal of each DCC. <a href=https://twiki.cern.ch/twiki/bin/view/CMS/DQMShiftEcalExpert>DQMShiftEcalExpert</a>", 'draw': { 'withref': "yes" } }])

ebecalshifterlayout(dqmitems, "05 Timing/03 Timing Map",
  [{ 'path': "$prefix/EBTimingTask/EBTMT timing map", 'description': "Average timing (in clock units) of the good rechits (good shape and amplitude > 300 MeV). Expected about 5.5 clocks. Readout tower binning (5x5 crystals) is used. <a href=https://twiki.cern.ch/twiki/bin/view/CMS/DQMShiftEcalExpert>DQMShiftEcalExpert</a>", 'draw': { 'withref': "yes" } }],
  [{ 'path': "$prefix/EBTimingTask/EBTMT timing projection eta", 'description': "Average timing (in clock units) of the good rechits (good shape and amplitude > 300 MeV). Expected about 5.5 clocks. Readout tower binning (5x5 crystals) is used. <a href=https://twiki.cern.ch/twiki/bin/view/CMS/DQMShiftEcalExpert>DQMShiftEcalExpert</a>", 'draw': { 'withref': "yes" } },
   { 'path': "$prefix/EBTimingTask/EBTMT timing projection phi", 'description': "Average timing (in clock units) of the good rechits (good shape and amplitude > 300 MeV). Expected about 5.5 clocks. Readout tower binning (5x5 crystals) is used. <a href=https://twiki.cern.ch/twiki/bin/view/CMS/DQMShiftEcalExpert>DQMShiftEcalExpert</a>", 'draw': { 'withref': "yes" } }])

ebecalshifterlayout(dqmitems, "05 Timing/04 Timing Vs Amplitude",
  [{ 'path': "$prefix/EBTimingTask/EBTMT timing vs amplitude summary", 'description': "Average timing (in clock units) of the good rechits (good shape and amplitude > 300 MeV) vs. amplitude (ADC counts). Expected about 5.5 clocks timing for amplitudes above 12 ADC counts. <a href=https://twiki.cern.ch/twiki/bin/view/CMS/DQMShiftEcalExpert>DQMShiftEcalExpert</a>", 'draw': { 'withref': "yes" } }],
  [None])

ebecalshifterlayout(dqmitems, "05 Timing/04 Single Event Timing",
  [{ 'path': "$prefix/EBTimingTask/EBTMT timing 1D summary", 'description': "Single event timing (in clock units) of the good rechits (good shape and amplitude > 500 MeV). Expected about 5.5 clocks. <a href=https://twiki.cern.ch/twiki/bin/view/CMS/DQMShiftEcalExpert>DQMShiftEcalExpert</a>", 'draw': { 'withref': "yes" } }],
  [None])
...
ebecalshifterlayout(dqmitems, "06 Trigger + Selective Readout/10 SelectiveReadout EventSize",
  [{ 'path': "$prefix/EBSelectiveReadoutTask/EBSRT event size", 'description': "ECAL barrel event size (kB). Expected below 100 kB/event. <a href=https://twiki.cern.ch/twiki/bin/view/CMS/DQMShiftEcalExpert>DQMShiftEcalExpert</a>", 'draw': { 'withref': "yes" } }],
  [None])

ebecalshifterlayout(dqmitems, "06 Trigger + Selective Readout/11 SelectiveReadout AverageEventSize",
  [{ 'path': "$prefix/EBSelectiveReadoutTask/EBSRT DCC event size", 'description': "Average supermodule event size (kB). Expected below 100 kB/event. <a href=https://twiki.cern.ch/twiki/bin/view/CMS/DQMShiftEcalExpert>DQMShiftEcalExpert</a>", 'draw': { 'withref': "yes" } }],
  [None])

ebecalshifterlayout(dqmitems, "06 Trigger + Selective Readout/12 SelectiveReadout Payload",
  [{ 'path': "$prefix/EBSelectiveReadoutTask/EBSRT high interest payload", 'description': "Size of high interest trigger towers (kB). <a href=https://twiki.cern.ch/twiki/bin/view/CMS/DQMShiftEcalExpert>DQMShiftEcalExpert</a>", 'draw': { 'withref': "yes" } }],
  [{ 'path': "$prefix/EBSelectiveReadoutTask/EBSRT low interest payload", 'description': "Size of low interest trigger towers (kB). <a href=https://twiki.cern.ch/twiki/bin/view/CMS/DQMShiftEcalExpert>DQMShiftEcalExpert</a>", 'draw': { 'withref': "yes" } }])
...
ebecalshifterlayout(dqmitems, "07 Calibration/00 Laser/00 L$laser Quality",
  [{ 'path': "$prefix/EBSummaryClient/EBLT laser quality summary L$laser", 'description': "Quality summary of laser L$laser events. Expect green where the laser sequence fired, yellow elsewhere. Red spots are failed channels. Legend: green = good;  red = bad;  yellow = no entries. <a href=https://twiki.cern.ch/twiki/bin/view/CMS/DQMShiftEcalExpert>DQMShiftEcalExpert</a>" }])

ebecalshifterlayout(dqmitems, "07 Calibration/00 Laser/01 L$laser Errors",
  [{ 'path': "$prefix/EBSummaryClient/EBLT laser quality errors summary L$laser", 'description': "Errors occupancy for laser L$laser events for every supermodule. Expect 0 entries if no errors or no laser events in a given supermodule. <a href=https://twiki.cern.ch/twiki/bin/view/CMS/DQMShiftEcalExpert>DQMShiftEcalExpert</a>" }])

ebecalshifterlayout(dqmitems, "07 Calibration/00 Laser/02 L$laser Amplitude",
  [{ 'path': "$prefix/EBSummaryClient/EBLT laser L$laser amplitude summary", 'description': "Laser L$laser average amplitude for fired light modules. <a href=https://twiki.cern.ch/twiki/bin/view/CMS/DQMShiftEcalExpert>DQMShiftEcalExpert</a>" }],
  [{ 'path': "$prefix/EBSummaryClient/EBLT laser L$laser amplitude over PN summary", 'description': "Laser L$laser APD/PN ratio for fired light modules. <a href=https://twiki.cern.ch/twiki/bin/view/CMS/DQMShiftEcalExpert>DQMShiftEcalExpert</a>" }])

ebecalshifterlayout(dqmitems, "07 Calibration/00 Laser/03 L$laser Timing",
  [{ 'path': "$prefix/EBSummaryClient/EBLT laser L$laser timing summary", 'description': "Laser L$laser average timing (in pulse shape samples) for fired light modules. Expect value around 6.5. <a href=https://twiki.cern.ch/twiki/bin/view/CMS/DQMShiftEcalExpert>DQMShiftEcalExpert</a>" }],
  [None])

ebecalshifterlayout(dqmitems, "07 Calibration/00 Laser/04 L$laser PNQuality",
...
ebecalshifterlayout(dqmitems, "07 Calibration/01 Pedestal/00 Quality Gain$gain",
...
ebecalshifterlayout(dqmitems, "07 Calibration/01 Pedestal/01 PNQuality Gain$gainPN",
...
ebecalshifterlayout(dqmitems, "07 Calibration/02 TestPulse/00 Quality Gain$gain",
...
ebecalshifterlayout(dqmitems, "07 Calibration/02 TestPulse/01 Amplitude Gain$gain",
...
ebecalshifterlayout(dqmitems, "07 Calibration/02 TestPulse/05 PNQuality Gain$gainPN",
...
ebecalshifterlayout(dqmitems, "08 Trend/02 Hits Number",
  [{ 'path': "$prefix/EBTrendTask/AverageNumberOfEcalRecHitVs5Minutes", 'description': "Average number of barrel reconstructed hits (5 minutes range). <a href=https://twiki.cern.ch/twiki/bin/view/CMS/DQMShiftEcalExpert>DQMShiftEcalExpert</a>" }],
  [{ 'path': "$prefix/EBTrendTask/AverageNumberOfEcalRecHitVs1Hour", 'description': "Average number of barrel reconstructed hits (1 hour range). <a href=https://twiki.cern.ch/twiki/bin/view/CMS/DQMShiftEcalExpert>DQMShiftEcalExpert</a>" }])
...
eblayout(dqmitems, "01 By Supermodule/$eb1/06 Cosmic",
  [{ 'path': "$prefix/EBCosmicTask/Sel/EBCT energy sel $eb2", 'description': "Average energy of the rechits selected with a simple cosmic analysis. <a href=https://twiki.cern.ch/twiki/bin/view/CMS/DQMShiftEcalExpert>DQMShiftEcalExpert</a>" }],
  [{ 'path': "$prefix/EBCosmicTask/Spectrum/EBCT 1x1 energy spectrum $eb2", 'description': "Calibrated energy spectrum of the reconstructed rechits selected with a simple cosmic analysis. <a href=https://twiki.cern.ch/twiki/bin/view/CMS/DQMShiftEcalExpert>DQMShiftEcalExpert</a>", 'draw': { 'withref': "yes" } },
   { 'path': "$prefix/EBCosmicTask/Spectrum/EBCT 3x3 energy spectrum $eb2", 'description': "Calibrated energy spectrum of the reconstructed 3x3 matrices rechits around a seed selected with a simple cosmic analysis. <a href=https://twiki.cern.ch/twiki/bin/view/CMS/DQMShiftEcalExpert>DQMShiftEcalExpert</a>", 'draw': { 'withref': "yes" } }])
...
eblayout(dqmitems, "01 By Supermodule/$eb1/Experts/06 Cosmic/00 Cosmic",
  [{ 'path': "$prefix/EBCosmicTask/Sel/EBCT energy sel $eb2", 'description': "Average energy (in GeV) of hits selected with cosmics analysis. Physics events only. <a href=https://twiki.cern.ch/twiki/bin/view/CMS/DQMShiftEcalExpert>DQMShiftEcalExpert</a>" }],
  [{ 'path': "$prefix/EBOccupancyTask/EBOT rec hit energy $eb2", 'description': "Average energy (in GeV) of hits over threshold (150 MeV). Physics events only. <a href=https://twiki.cern.ch/twiki/bin/view/CMS/DQMShiftEcalExpert>DQMShiftEcalExpert</a>" }])

eblayout(dqmitems, "01 By Supermodule/$eb1/Experts/07 Cosmic/01 Cosmic",
  [{ 'path': "$prefix/EBCosmicTask/Spectrum/EBCT 1x1 energy spectrum $eb2", 'description': "<a href=https://twiki.cern.ch/twiki/bin/view/CMS/DQMShiftEcalExpert>DQMShiftEcalExpert</a>", 'draw': { 'withref': "yes" } }],
  [{ 'path': "$prefix/EBCosmicTask/Spectrum/EBCT 3x3 energy spectrum $eb2", 'description': "<a href=https://twiki.cern.ch/twiki/bin/view/CMS/DQMShiftEcalExpert>DQMShiftEcalExpert</a>", 'draw': { 'withref': "yes" } }])
EOF06
...
eblayout(dqmitems, "00 By Task/00 Summary/03 Cosmic Summary",
  [{ 'path': "$prefix/EBSummaryClient/EBCT cosmic summary", 'description': "<a href=https://twiki.cern.ch/twiki/bin/view/CMS/DQMShiftEcalExpert>DQMShiftEcalExpert</a>" }])
...
eblayout(dqmitems, "00 By Task/09 Cosmic/00 Cosmic Summary",
  [{ 'path': "$prefix/EBSummaryClient/EBCT cosmic summary", 'description': "Average energy (in GeV) of hits selected with cosmics analysis. <a href=https://twiki.cern.ch/twiki/bin/view/CMS/DQMShiftEcalExpert>DQMShiftEcalExpert</a>" }])

eblayout(dqmitems, "00 By Task/09 Cosmic/$eb1/00 Cosmic",
  [{ 'path': "$prefix/EBCosmicTask/Sel/EBCT energy sel $eb2", 'description': "Average energy (in GeV) of hits selected with cosmics analysis. Physics events only. <a href=https://twiki.cern.ch/twiki/bin/view/CMS/DQMShiftEcalExpert>DQMShiftEcalExpert</a>" }],
  [{ 'path': "$prefix/EBOccupancyTask/EBOT rec hit energy $eb2", 'description': "Average energy (in GeV) of hits over threshold (150 MeV). Physics events only. <a href=https://twiki.cern.ch/twiki/bin/view/CMS/DQMShiftEcalExpert>DQMShiftEcalExpert</a>" }])

eblayout(dqmitems, "00 By Task/09 Cosmic/$eb1/01 Cosmic",
  [{ 'path': "$prefix/EBCosmicTask/Spectrum/EBCT 1x1 energy spectrum $eb2", 'description': "<a href=https://twiki.cern.ch/twiki/bin/view/CMS/DQMShiftEcalExpert>DQMShiftEcalExpert</a>", 'draw': { 'withref': "yes" } }],
  [{ 'path': "$prefix/EBCosmicTask/Spectrum/EBCT 3x3 energy spectrum $eb2", 'description': "<a href=https://twiki.cern.ch/twiki/bin/view/CMS/DQMShiftEcalExpert>DQMShiftEcalExpert</a>", 'draw': { 'withref': "yes" } }])
