...
ebecalshifterlayout(dqmitems, "01 Electronics/04 DCC - FE Synchronization",
...
ebecalshifterlayout(dqmitems, "07 Selective Readout/00 Full Readout, ZS Flags",
  [{ 'path': "$prefix/EBSelectiveReadoutTask/EBSRT full readout SR Flags", 'description': "Rate at which a readout unit is selected for a full readout (Full readout selective readout flags). It must be less than 0.05. <a href=https://twiki.cern.ch/twiki/bin/view/CMS/DQMShiftEcalExpert>DQMShiftEcalExpert</a>" }],
  [{ 'path': "$prefix/EBSelectiveReadoutTask/EBSRT zero suppression 1 SR Flags", 'description': "Rate at which a readout unit is selected to have zero suppression applied on its channels. It must be larger than 0.95. <a href=https://twiki.cern.ch/twiki/bin/view/CMS/DQMShiftEcalExpert>DQMShiftEcalExpert</a>" }])

ebecalshifterlayout(dqmitems, "07 Selective Readout/01 Number of Full Readout Requests",
  [{ 'path': "$prefix/EBSelectiveReadoutTask/EBSRT full readout SR Flags Number", 'description': "Number of barrel readout units requested to be fully-readout (Full readout selective readout flag). <a href=https://twiki.cern.ch/twiki/bin/view/CMS/DQMShiftEcalExpert>DQMShiftEcalExpert</a>" }])

ebecalshifterlayout(dqmitems, "07 Selective Readout/02 Trigger Primitives Flags",
  [{ 'path': "$prefix/EBSelectiveReadoutTask/EBSRT high interest TT Flags", 'description': "Rate of high-interest flag for each trigger tower. A high-interest flag triggers the readout of a 3x3 trigger tower region (which in the endcap is extended to a larger region made of complete readout unit). <a href=https://twiki.cern.ch/twiki/bin/view/CMS/DQMShiftEcalExpert>DQMShiftEcalExpert</a>" }],
  [{ 'path': "$prefix/EBSelectiveReadoutTask/EBSRT medium interest TT Flags", 'description': "Rate of mid-interest flag for each trigger tower. A mid-interest flag triggers the readout of a 1x1 trigger tower region. <a href=https://twiki.cern.ch/twiki/bin/view/CMS/DQMShiftEcalExpert>DQMShiftEcalExpert</a>" }])

ebecalshifterlayout(dqmitems, "07 Selective Readout/03 Trigger Primitives Flags",
  [{ 'path': "$prefix/EBSelectiveReadoutTask/EBSRT low interest TT Flags", 'description': "Rate of low-interest flag for each trigger tower. <a href=https://twiki.cern.ch/twiki/bin/view/CMS/DQMShiftEcalExpert>DQMShiftEcalExpert</a>" }],
  [{ 'path': "$prefix/EBSelectiveReadoutTask/EBSRT readout unit with SR forced", 'description': "Rate at which a trigger tower flag was forced either by configuration or following to an error. In current online configuration, the flag is forced to low interest. <a href=https://twiki.cern.ch/twiki/bin/view/CMS/DQMShiftEcalExpert>DQMShiftEcalExpert</a>" }])

ebecalshifterlayout(dqmitems, "07 Selective Readout/04 Trigger Primitives ET",
  [{ 'path': "$prefix/EBSummaryClient/EBTTT Et trigger tower summary", 'description': "Averaged trigger primitive value (transverse energy) for each trigger tower. <a href=https://twiki.cern.ch/twiki/bin/view/CMS/DQMShiftEcalExpert>DQMShiftEcalExpert</a>" }],
  [{ 'path': "$prefix/EBTriggerTowerTask/EBTTT Et spectrum Real Digis", 'description': "Average transverse energy (4 ADC count = 1 GeV) of real L1 trigger primitives. <a href=https://twiki.cern.ch/twiki/bin/view/CMS/DQMShiftEcalExpert>DQMShiftEcalExpert</a>", 'draw': { 'withref': "yes" } }])

ebecalshifterlayout(dqmitems, "07 Selective Readout/05 Trigger Primitive Flags",
  [{ 'path': "$prefix/EBSelectiveReadoutTask/EBSRT TT Flags", 'description': "Distribution of trigger tower flag (TTF) values. 0: low interest; 1: mid interest; 2: forbidden; 3: high interest. 4 is added to the flag value if flag was forced by configuration or because of an error. With current configuration: There should be no flags 5, 6 or 7; Tower is flagged mid-interest between 1 and 2 GeV; Flag is flagged high-interest above 2 GeV. <a href=https://twiki.cern.ch/twiki/bin/view/CMS/DQMShiftEcalExpert>DQMShiftEcalExpert</a>" }])

ebecalshifterlayout(dqmitems, "07 Selective Readout/06 ZS1-Flagged Fully Readout Units",
  [{ 'path': "$prefix/EBSelectiveReadoutTask/EBSRT ZS Flagged Fully Readout", 'description': "Rate at which a readout unit saw all is channels read out while a zero-suppression was requested. This rate must be negligle when selective readout decision is correctly applied. <a href=https://twiki.cern.ch/twiki/bin/view/CMS/DQMShiftEcalExpert>DQMShiftEcalExpert</a>" }],
  [{ 'path': "$prefix/EBSelectiveReadoutTask/EBSRT ZS Flagged Fully Readout Number", 'description': "Number of readout unit whose every channel was read out while a zero-suppression was requested. A non-zero value is very improbable when selective readout decision is correctly applied. <a href=https://twiki.cern.ch/twiki/bin/view/CMS/DQMShiftEcalExpert>DQMShiftEcalExpert</a>" }])

ebecalshifterlayout(dqmitems, "07 Selective Readout/07 Fully-Readout Dropped Units",
  [{ 'path': "$prefix/EBSelectiveReadoutTask/EBSRT FR Flagged Dropped Readout", 'description': "Rate at which a readout unit had none of its channel read out, while a full readout was requested. Only masked tower are expected to have a non-null rate, in occurence a 100% rate. <a href=https://twiki.cern.ch/twiki/bin/view/CMS/DQMShiftEcalExpert>DQMShiftEcalExpert</a>" }],
  [{ 'path': "$prefix/EBSelectiveReadoutTask/EBSRT FR Flagged Dropped Readout Number", 'description': "Number of readout units whose none of the channels was read out, while a full readout was requested. <a href=https://twiki.cern.ch/twiki/bin/view/CMS/DQMShiftEcalExpert>DQMShiftEcalExpert</a>" }])

ebecalshifterlayout(dqmitems, "07 Selective Readout/08 Barrel Payload",
  [{ 'path': "$prefix/EBSelectiveReadoutTask/EBSRT event size", 'description': "Size of data from barrel within the ECAL event. The averaged event size must be below 100kB. <a href=https://twiki.cern.ch/twiki/bin/view/CMS/DQMShiftEcalExpert>DQMShiftEcalExpert</a>" }])

ebecalshifterlayout(dqmitems, "07 Selective Readout/09 HI, LI Barrel Payload",
  [{ 'path': "$prefix/EBSelectiveReadoutTask/EBSRT high interest payload", 'description': "Size of barrel crystal-channel data in high interest region within the ECAL event. <a href=https://twiki.cern.ch/twiki/bin/view/CMS/DQMShiftEcalExpert>DQMShiftEcalExpert</a>" }],
  [{ 'path': "$prefix/EBSelectiveReadoutTask/EBSRT low interest payload", 'description': "Size of barrel crystal-channel data in low interest region within the ECAL event. <a href=https://twiki.cern.ch/twiki/bin/view/CMS/DQMShiftEcalExpert>DQMShiftEcalExpert</a>" }])

ebecalshifterlayout(dqmitems, "07 Selective Readout/10 DCC Event Size",
  [{ 'path': "$prefix/EBSelectiveReadoutTask/EBSRT DCC event size", 'description': "ECAL event fragment size per DCC. Here the size of event fragment in the raw data (FEDRawData) is used. The size must be less or equal to 2kB. <a href=https://twiki.cern.ch/twiki/bin/view/CMS/DQMShiftEcalExpert>DQMShiftEcalExpert</a>", 'draw': { 'withref': "yes" } }],
...
ebecalshifterlayout(dqmitems, "07 Selective Readout/11 Tower Size",
...
ebecalshifterlayout(dqmitems, "07 Selective Readout/11 ZS Filter Output",
  [{ 'path': "$prefix/EBSelectiveReadoutTask/EBSRT high interest ZS filter output", 'description': "Barrel High Interest ZS emulation. Signal of channels from barrel high interest regions as reconstructed by the ZS emulator. Notes: These plots rely on the match of the ZS configuration with the online setting. Little excess in bin ADC_count = 0 is expected. It is due to the rounding done in the ZS filter. Positive values are round down, while negative values are round up. <a href=https://twiki.cern.ch/twiki/bin/view/CMS/DQMShiftEcalExpert>DQMShiftEcalExpert</a>", 'draw': { 'withref': "yes" } }],
  [{ 'path': "$prefix/EBSelectiveReadoutTask/EBSRT low interest ZS filter output", 'description': "Barrel Low Interest ZS emulation. Signal of channels from barrel low interest regions as reconstructed by the ZS emulator. A sharp cut at zero suppression threshold is expected, with all bins below this threshold empty. <a href=https://twiki.cern.ch/twiki/bin/view/CMS/DQMShiftEcalExpert>DQMShiftEcalExpert</a>", 'draw': { 'withref': "yes" } }])
...
eblayout(dqmitems, "00 By Task/14 SelectiveReadout/00 Full Readout, ZS Flags",
  [{ 'path': "$prefix/EBSelectiveReadoutTask/EBSRT full readout SR Flags", 'description': "Rate at which a readout unit is selected for a full readout (Full readout selective readout flags). It must be less than 0.05. <a href=https://twiki.cern.ch/twiki/bin/view/CMS/DQMShiftEcalExpert>DQMShiftEcalExpert</a>" }],
  [{ 'path': "$prefix/EBSelectiveReadoutTask/EBSRT zero suppression 1 SR Flags", 'description': "Rate at which a readout unit is selected to have zero suppression applied on its channels. It must be larger than 0.95. <a href=https://twiki.cern.ch/twiki/bin/view/CMS/DQMShiftEcalExpert>DQMShiftEcalExpert</a>" }])

eblayout(dqmitems, "00 By Task/14 SelectiveReadout/01 Number of Full Readout Requests",
  [{ 'path': "$prefix/EBSelectiveReadoutTask/EBSRT full readout SR Flags Number", 'description': "Number of barrel readout units requested to be fully-readout (Full readout selective readout flag). <a href=https://twiki.cern.ch/twiki/bin/view/CMS/DQMShiftEcalExpert>DQMShiftEcalExpert</a>" }])

eblayout(dqmitems, "00 By Task/14 SelectiveReadout/02 Trigger Primitives Flags",
  [{ 'path': "$prefix/EBSelectiveReadoutTask/EBSRT high interest TT Flags", 'description': "Rate of high-interest flag for each trigger tower. A high-interest flag triggers the readout of a 3x3 trigger tower region (which in the endcap is extended to a larger region made of complete readout unit). <a href=https://twiki.cern.ch/twiki/bin/view/CMS/DQMShiftEcalExpert>DQMShiftEcalExpert</a>" }],
  [{ 'path': "$prefix/EBSelectiveReadoutTask/EBSRT medium interest TT Flags", 'description': "Rate of mid-interest flag for each trigger tower. A mid-interest flag triggers the readout of a 1x1 trigger tower region. <a href=https://twiki.cern.ch/twiki/bin/view/CMS/DQMShiftEcalExpert>DQMShiftEcalExpert</a>" }])

eblayout(dqmitems, "00 By Task/14 SelectiveReadout/03 Trigger Primitives Flags",
  [{ 'path': "$prefix/EBSelectiveReadoutTask/EBSRT low interest TT Flags", 'description': "Rate of low-interest flag for each trigger tower. <a href=https://twiki.cern.ch/twiki/bin/view/CMS/DQMShiftEcalExpert>DQMShiftEcalExpert</a>" }],
  [{ 'path': "$prefix/EBSelectiveReadoutTask/EBSRT readout unit with SR forced", 'description': "Rate at which a trigger tower flag was forced either by configuration or following to an error. In current online configuration, the flag is forced to low interest. <a href=https://twiki.cern.ch/twiki/bin/view/CMS/DQMShiftEcalExpert>DQMShiftEcalExpert</a>" }])

eblayout(dqmitems, "00 By Task/14 SelectiveReadout/04 Trigger Primitives ET",
  [{ 'path': "$prefix/EBSummaryClient/EBTTT Et trigger tower summary", 'description': "Averaged trigger primitive value (transverse energy) for each trigger tower. <a href=https://twiki.cern.ch/twiki/bin/view/CMS/DQMShiftEcalExpert>DQMShiftEcalExpert</a>" }],
  [{ 'path': "$prefix/EBTriggerTowerTask/EBTTT Et spectrum Real Digis", 'description': "Average transverse energy (4 ADC count = 1 GeV) of real L1 trigger primitives. <a href=https://twiki.cern.ch/twiki/bin/view/CMS/DQMShiftEcalExpert>DQMShiftEcalExpert</a>", 'draw': { 'withref': "yes" } }])

eblayout(dqmitems, "00 By Task/14 SelectiveReadout/05 Trigger Primitive Flags",
  [{ 'path': "$prefix/EBSelectiveReadoutTask/EBSRT TT Flags", 'description': "Distribution of trigger tower flag (TTF) values. 0: low interest; 1: mid interest; 2: forbidden; 3: high interest. 4 is added to the flag value if flag was forced by configuration or because of an error. With current configuration: There should be no flags 5, 6 or 7; Tower is flagged mid-interest between 1 and 2 GeV; Flag is flagged high-interest above 2 GeV. <a href=https://twiki.cern.ch/twiki/bin/view/CMS/DQMShiftEcalExpert>DQMShiftEcalExpert</a>" }])

eblayout(dqmitems, "00 By Task/14 SelectiveReadout/06 ZS1-Flagged Fully Readout Units",
  [{ 'path': "$prefix/EBSelectiveReadoutTask/EBSRT ZS Flagged Fully Readout", 'description': "Rate at which a readout unit saw all is channels read out while a zero-suppression was requested. This rate must be negligle when selective readout decision is correctly applied. <a href=https://twiki.cern.ch/twiki/bin/view/CMS/DQMShiftEcalExpert>DQMShiftEcalExpert</a>" }],
  [{ 'path': "$prefix/EBSelectiveReadoutTask/EBSRT ZS Flagged Fully Readout Number", 'description': "Number of readout unit whose every channel was read out while a zero-suppression was requested. A non-zero value is very improbable when selective readout decision is correctly applied. <a href=https://twiki.cern.ch/twiki/bin/view/CMS/DQMShiftEcalExpert>DQMShiftEcalExpert</a>" }])
...
eblayout(dqmitems, "00 By Task/14 SelectiveReadout/09 HI, LI Barrel Payload",
  [{ 'path': "$prefix/EBSelectiveReadoutTask/EBSRT high interest payload", 'description': "Size of barrel crystal-channel data in high interest region within the ECAL event. <a href=https://twiki.cern.ch/twiki/bin/view/CMS/DQMShiftEcalExpert>DQMShiftEcalExpert</a>" }],
  [{ 'path': "$prefix/EBSelectiveReadoutTask/EBSRT low interest payload", 'description': "Size of barrel crystal-channel data in low interest region within the ECAL event. <a href=https://twiki.cern.ch/twiki/bin/view/CMS/DQMShiftEcalExpert>DQMShiftEcalExpert</a>" }])

eblayout(dqmitems, "00 By Task/14 SelectiveReadout/10 DCC Event Size",
  [{ 'path': "$prefix/EBSelectiveReadoutTask/EBSRT DCC event size", 'description': "ECAL event fragment size per DCC. Here the size of event fragment in the raw data (FEDRawData) is used. The size must be less or equal to 2kB. <a href=https://twiki.cern.ch/twiki/bin/view/CMS/DQMShiftEcalExpert>DQMShiftEcalExpert</a>", 'draw': { 'withref': "yes" } }],
  [{ 'path': "$prefix/EBSelectiveReadoutTask/EBSRT event size vs DCC", 'description': "Event size distribution per each ECAL barrel DCC. Finer binning is used in the zero-suppressed region (0-0.608 kB), while granularity of one fully readout tower (0.608 kB) has been used for higher sizes. <a href=https://twiki.cern.ch/twiki/bin/view/CMS/DQMShiftEcalExpert>DQMShiftEcalExpert</a>"}])

eblayout(dqmitems, "00 By Task/14 SelectiveReadout/11 Tower Size",
  [{ 'path': "$prefix/EBSelectiveReadoutTask/EBSRT tower event size", 'description': "Event size distribution per tower. This plot allows to verify the correctness of the ZS thresholds applied. The average of the plot has to be ~ 2kB / 68 ~ 30 bytes.<a href=https://twiki.cern.ch/twiki/bin/view/CMS/DQMShiftEcalExpert>DQMShiftEcalExpert</a>" }],
  [None])
