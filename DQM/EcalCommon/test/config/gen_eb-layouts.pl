...
ebecalshifterlayout(dqmitems, "07 Selective Readout/00 EventSize",
  [{ 'path': "$prefix/EBSelectiveReadoutTask/EBSRT event size", 'description': "Event size for the readout crystals in the ECAL barrel.  The averaged event size must be below 100kB. <a href=https://twiki.cern.ch/twiki/bin/view/CMS/DQMShiftEcalExpert>DQMShiftEcalExpert</a>", 'draw': { 'withref': "yes" } }],
...
ebecalshifterlayout(dqmitems, "07 Selective Readout/01 DCC EventSize",
  [{ 'path': "$prefix/EBSelectiveReadoutTask/EBSRT DCC event size", 'description': "ECAL event fragment size per DCC. Here size is computed from the list of channels that were read out. The size must be less or equal to 2kB. <a href=https://twiki.cern.ch/twiki/bin/view/CMS/DQMShiftEcalExpert>DQMShiftEcalExpert</a>", 'draw': { 'withref': "yes" } }],
...
ebecalshifterlayout(dqmitems, "07 Selective Readout/02 SRFlags",
  [{ 'path': "$prefix/EBSelectiveReadoutTask/EBSRT readout unit with SR forced", 'description': "Trigger tower flag forced bit. Rate at which a trigger tower flag was forced either by configuration or following to an error. In current online configuration, the flag is forced to low interest. <a href=https://twiki.cern.ch/twiki/bin/view/CMS/DQMShiftEcalExpert>DQMShiftEcalExpert</a>" }],
...
ebecalshifterlayout(dqmitems, "07 Selective Readout/03 TTFlags",
  [{ 'path': "$prefix/EBSelectiveReadoutTask/EBSRT high interest TT Flags", 'description': "High Interest Trigger Tower Flag. Rate of high-interest flag for each trigger tower. A high-interest flag triggers the readout of a 3x3 trigger tower region (which in the endcap is extended to a larger region made of complete readout unit). <a href=https://twiki.cern.ch/twiki/bin/view/CMS/DQMShiftEcalExpert>DQMShiftEcalExpert</a>" }],
  [{ 'path': "$prefix/EBSelectiveReadoutTask/EBSRT low interest TT Flags", 'description': "Low Interest Trigger Tower Flag. Rate of low-interest flag for each trigger tower. <a href=https://twiki.cern.ch/twiki/bin/view/CMS/DQMShiftEcalExpert>DQMShiftEcalExpert</a>" }])

ebecalshifterlayout(dqmitems, "07 Selective Readout/04 Payload",
  [{ 'path': "$prefix/EBSelectiveReadoutTask/EBSRT high interest payload", 'description': "Barrel HI payload. Size of barrel crystal-channel data in high interest region within the ECAL event. <a href=https://twiki.cern.ch/twiki/bin/view/CMS/DQMShiftEcalExpert>DQMShiftEcalExpert</a>", 'draw': { 'withref': "yes" } }],
  [{ 'path': "$prefix/EBSelectiveReadoutTask/EBSRT low interest payload", 'description': "Barrel LI payload. Size of barrel crystal-channel data in high interest region within the ECAL event. <a href=https://twiki.cern.ch/twiki/bin/view/CMS/DQMShiftEcalExpert>DQMShiftEcalExpert</a>", 'draw': { 'withref': "yes" } }])
