...
// $Id: FW3DLegoDataProxyBuilderFactory.h,v 1.5 2009/04/27 14:42:33 chrjones Exp $
//
...
#define REGISTER_FW3DLEGODATAPROXYBUILDER(_name_,_type_,_purpose_) \
   ...
   DEFINE_EDM_PLUGIN(FW3DLegoDataProxyBuilderFactory,_name_,_name_::typeOfBuilder()+_name_::classRegisterTypeName()+"@"+_name_::classPurpose()+"@" # _name_)
