...
process.configurationMetadata = cms.untracked.PSet(
    ...
    name = cms.untracked.string('$Source: /afs/cern.ch/work/c/cmsbuild/public/cvs/CMSSW/CMSSW/Alignment/MuonAlignmentAlgorithms/test/runDTLocalMillepede.py,v $'),
...
process.load("Alignment.MuonAlignmentAlgorithms.MuonDTLocalMillepedeAlgorithm_cfi")
process.MuonDTLocalMillepedeAlgorithm.workingMode = cms.int32(0)
...
#connect = cms.string("sqlite_file:/afs/cern.ch/user/s/scodella/scratch0/SoftwareAlignment/CMSSW_2_2_9/src/Alignment/MuonAlignment/test/IdealMillepedeSolutionsApplied.db"),
#connect = cms.string("sqlite_file:/afs/cern.ch/user/s/scodella/scratch0/SoftwareAlignment/CMSSW_2_2_9/src/Alignment/MuonAlignment/test/MonteCarloMillepedeSolutionsApplied.db"),
#connect = cms.string("sqlite_file:/afs/cern.ch/user/s/scodella/scratch0/SoftwareAlignment/CMSSW_2_2_9/src/Alignment/MuonAlignment/test/ConstraintMillepedeSolutions.db"),
#connect = cms.string("sqlite_file:/afs/cern.ch/user/s/scodella/scratch0/SoftwareAlignment/CMSSW_2_2_9/src/Alignment/MuonAlignment/test/SurveyMillepedeSolutions.db"),
connect = cms.string("sqlite_file:/afs/cern.ch/user/s/scodella/scratch0/SoftwareAlignment/CMSSW_2_2_9/src/Alignment/MuonAlignment/test/MisalignmentScenarioForInternalAlignmentTight.db"),
