...
process.configurationMetadata = cms.untracked.PSet(
    ...
    name = cms.untracked.string('$Source: /afs/cern.ch/work/c/cmsbuild/public/cvs/CMSSW/CMSSW/Alignment/MuonAlignmentAlgorithms/test/runDTLocalMillepedeFit.py,v $'),
