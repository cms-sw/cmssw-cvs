...
process.configurationMetadata = cms.untracked.PSet(
    ...
    name = cms.untracked.string('$Source: /afs/cern.ch/work/c/cmsbuild/public/cvs/CMSSW/CMSSW/Alignment/MuonAlignmentAlgorithms/test/runDTLocalMillepedeData.py,v $'),
...
#connect = cms.string("sqlite_file:/afs/cern.ch/user/s/scodella/scratch0/SoftwareAlignment/CMSSW_3_2_2/src/Alignment/MuonAlignment/test/DesignISR.db"),
connect = cms.string("sqlite_file:/afs/cern.ch/user/s/scodella/scratch0/SoftwareAlignment/CMSSW_3_2_2/src/Alignment/MuonAlignment/test/ConstraintMillepedeSolutionsData2.db"),
#connect = cms.string("sqlite_file:/afs/cern.ch/user/s/scodella/scratch0/SoftwareAlignment/CMSSW_3_2_2/src/Alignment/MuonAlignment/test/SurveyMillepedeSolutionsData.db"),
