...
//INCLUDECHECKER: Removed this line: #include <G4UserSpecialCuts.hh>
...
VisG4ExamplePhysics::ConstructProcess (void)
{
	...
	{
	    G4VProcess *multipleScattering	= new G4eMultipleScattering ();
	...
	{
	    G4VProcess *multipleScattering	= new G4MuMultipleScattering ();
