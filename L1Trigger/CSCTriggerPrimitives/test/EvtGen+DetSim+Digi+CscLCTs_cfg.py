...
process.configurationMetadata = cms.untracked.PSet(
    ...
    name = cms.untracked.string("$Source: /afs/cern.ch/work/c/cmsbuild/public/cvs/CMSSW/CMSSW/L1Trigger/CSCTriggerPrimitives/test/EvtGen+DetSim+Digi+CscLCTs_cfg.py,v $"),
