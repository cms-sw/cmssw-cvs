...
process.MessageLogger = cms.Service(
    "MessageLogger",
    debugModules = cms.untracked.vstring('siStripModuleHVDummyDBWriter'),
    threshold = cms.untracked.string('DEBUG'),
    destinations = cms.untracked.vstring('ModuleHVBuilder.log')
)
...
process.PoolDBOutputService = cms.Service("PoolDBOutputService",
    ...
    toPut = cms.VPSet(cms.PSet(
        ...
        tag = cms.string('SiStripModuleHVOff_Ideal_31X')
    ))
)
