#ifndef VIS_TRACKER_VIS_TRACKER_RECHIT2D_TWIG_H
# define VIS_TRACKER_VIS_TRACKER_RECHIT2D_TWIG_H
...
class VisTrackerRechit2DTwig : public VisQueuedTwig
{
public:
    VisTrackerRechit2DTwig (IgState *state, IgTwig *parent, 
...
#endif // VIS_TRACKER_VIS_TRACKER_RECHIT2D_TWIG_H
