#ifndef VIS_MUON_DT_VIS_DT4DSEGMENT_TWIG_H
# define VIS_MUON_DT_VIS_DT4DSEGMENT_TWIG_H
...
class VisDT4DSegmentTwig : public VisQueuedTwig
{
public:
    VisDT4DSegmentTwig (IgState *state, IgTwig *parent, 
...
private:
    ...
    std::vector< DTRecSegment4D >             m_recseg;
