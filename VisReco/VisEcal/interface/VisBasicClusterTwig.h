#ifndef VIS_ECAL_VIS_BASIC_CLUSTER_TWIG_H
# define VIS_ECAL_VIS_BASIC_CLUSTER_TWIG_H
...
class VisBasicClusterTwig : public VisQueuedTwig
{
public:
    VisBasicClusterTwig (IgState *state, IgTwig *parent, const std::string &name,
...
#endif // VIS_ECAL_VIS_BASIC_CLUSTER_TWIG_H
