#ifndef VIS_ECAL_VIS_SUPER_CLUSTER_COLLECTION_TWIG_H
# define VIS_ECAL_VIS_SUPER_CLUSTER_COLLECTION_TWIG_H
...
class VisSuperClusterCollectionTwig : public VisQueuedTwig
{
public:
    VisSuperClusterCollectionTwig (IgState *state, IgTwig *parent, 
...
private:
    ...
    std::vector<reco::SuperCluster>  m_clusters;
...
#endif // VIS_ECAL_VIS_SUPER_CLUSTER_COLLECTION_TWIG_H
