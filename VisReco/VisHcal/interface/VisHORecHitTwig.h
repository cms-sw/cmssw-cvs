#ifndef VIS_HCAL_VIS_HOREC_HIT_TWIG_H
# define VIS_HCAL_VIS_HOREC_HIT_TWIG_H
...
class VisHORecHitTwig : public VisQueuedTwig
{
public:
    VisHORecHitTwig (IgState *state, IgTwig *parent,
...
#endif // VIS_HCAL_VIS_HOREC_HIT_TWIG_H
